...
namespace Discuz.Forum
{
    ...
    public class Users
    {
        ...
        public static void SaveUserIDToCookie(int UserID)
        {
            ...
            HttpCookie cookieUser = new HttpCookie(Key, Shove._Security.Encrypt.Encrypt3DES(Common.Utils.GetCallCert(), Shove._Security.Encrypt.EncryptString(Discuz.Common.Utils.GetCallCert(), UserID.ToString()), Common.Utils.DesKey));
            cookieUser.Path = "/";

            //String sURL = Shove._Web.Utility.GetUrl();

            //if (sURL.Contains("localhost"))
            //{
            //    cookieUser.Domain = "";
            //    cookieUser.Path = "/";
            //    cookieUser.Secure = false;
            //}
            //else
            //{
            //    cookieUser.Domain = sURL.Substring(sURL.IndexOf("."));
            //    cookieUser.Path = "/";
            //    cookieUser.Secure = false;
            //}
            ...
            try
            {
                ...
                //HttpContext.Current.Session[Key] = Shove._Security.Encrypt.Encrypt3DES(Common.Utils.GetCallCert(), Shove._Security.Encrypt.EncryptString(Discuz.Common.Utils.GetCallCert(), UserID.ToString()), Common.Utils.DesKey);
            }
            catch (Exception e)
            {
                Discuz.Forum.ScheduledEvents.EventLogs.WriteFailedLog("Discuz.Forum.Users(-1156)," + e.Message);
            }
        }
        ...
        public static void RemoveUserIDFromCookie()
        {
            ...
            {
                Discuz.Forum.ScheduledEvents.EventLogs.WriteFailedLog("Discuz.Forum.Users(-1179)," + e.Message);
            }
        }
        ...
        public static int GetUserIDFromCookie()
        {
            ...
            //try
            //{
            //    CookieUserID = HttpContext.Current.Session[Key].ToString();
            //}
            //catch { }
