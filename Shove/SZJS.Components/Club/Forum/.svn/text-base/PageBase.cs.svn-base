    ...
    public class PageBase : System.Web.UI.Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (templateid == 1)   //默认模板加载头部
            {
                ...
                buyPage = SiteUrl + "/Lottery/buy.aspx";
                indexPage = SiteUrl + "/Index.aspx";
            ...
            else      //新模板加载头部
            {
                ...
                templateBuilder.Append("                    <td width='6' background='images/head_line_blue.jpg'>&nbsp;</td>\r\n");
                templateBuilder.Append("                    <td width='55' align='center' class='cyw_menu'>\r\n");
                templateBuilder.Append("                        <a id=\"live800iconlink\"  href=\"javascript:;\" onclick=\"try{parent.closeMini();}catch(e){;}this.newWindow = window.open('http://chat10.live800.com/live800/chatClient/chatbox.jsp?companyID=86584&configID=149924&jid=8794095338&enterurl=http%3A%2F%2Flocalhost%3A2003%2FSLS%2EIcaile%2FHome%2FWeb%2FDefault%2Easpx', 'chatbox86584', 'toolbar=0');this.newWindow.focus();this.newWindow.opener=window;return false;\" target='_blank'>在线客服</asp:HyperLink>\r\n");
                templateBuilder.Append("                    </td>\r\n");
                templateBuilder.Append("                    <td width='6' background='images/head_line_blue.jpg'>&nbsp;</td>\r\n");
                templateBuilder.Append("                    <td>\r\n");
                if (userid != -1)
