...
namespace SZJS
{
    public partial class Lottery
    {
        ...
        public partial class JX11X5 : LotteryBase
        {
            ...
            public override string BuildNumber(int Num, int Type)
            {
                ...
                for (int i = 0; i < Num; i++)
                {
                    ...
                    for (int j = 0; j < Type; j++)
                        LotteryNumber += rd.Next(1, 9 + 1).ToString();
            ...
            public override string BuildNumber(int minValue, int maxValue, int Type)
            {
                ...
                Array.Copy(items, result, Type);

                string LotteryNumber = "";
                for (int k = 0; k < result.Length; k++)
                {
                    LotteryNumber += " " + result[k].ToString();
                }
