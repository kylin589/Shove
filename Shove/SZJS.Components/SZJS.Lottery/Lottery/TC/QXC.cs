        ...
        public partial class QXC : LotteryBase
        {
            ...
            public override double ComputeWin(string Number, string WinNumber, ref string Description, ref double WinMoneyNoWithTax, int PlayType, params double[] WinMoneyList)
            {
                ...
                for (int ii = 0; ii < Lotterys.Length; ii++)
                {
                    ...
                    if (IsRight[6] && IsRight[5] && IsRight[4] && IsRight[3] && IsRight[2] && IsRight[1])
                    {
                        int Count = Num[0];
                    ...
                    if (IsRight[5] && IsRight[4] && IsRight[3] && IsRight[2] && IsRight[1])
                    {
                        int Count = 0;
                    ...
                    if (IsRight[5] && IsRight[4] && IsRight[3] && IsRight[2])
                    {
                        int Count = Num[0];
                    ...
                    if (IsRight[3] && IsRight[2] && IsRight[1] && IsRight[0])
                    {
                    ...
                    if (IsRight[5] && IsRight[4] && IsRight[3])
                    {
                        int Count = Num[0] * Num[1];
                    ...
                    if (IsRight[3] && IsRight[2] && IsRight[1])
                    {
                    ...
                    if (IsRight[2] && IsRight[1] && IsRight[0])
                    {
