<%@ page language="C#" autoeventwireup="true" inherits="Admin_Open, App_Web_mq7qcqnw" validaterequest="false" enableEventValidation="false" %>
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr style="height: 28px" class="title">
                <td>
                    <font face="宋体">&nbsp; 请选择
                        ...
                        &nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="ReBuildWinDescription.aspx"
                            ForeColor="Red">重构中奖描述</asp:HyperLink>
                    </font>
                </td>
            </tr>
            <tr>
                <td style="height: 30px">
                    <table id="WinNumberZCDC" runat="server" visible="false" cellspacing="0" cellpadding="0"
                        width="94%" align="center" border="0">
                        <tr>
                            <td align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="width: 60px; height: 81px">
                                                    ...
                                                    <ShoveWebUI:ShoveConfirmButton ID="btUpdate" CommandName="btUpdate" runat="server"
                                                        Text="确定" />
                                                    <ShoveWebUI:ShoveConfirmButton ID="btOpenWin" CommandName="btOpenWin" runat="server"
                                                        Text="开奖" />
                                                </td>
                                            </tr>
                                        </table>
                                        <table align="center" style="width: 672px">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="height: 21px">
                                                    ...
                                                    <asp:TextBox ID="tbHalftimeResult" runat="server" Text='<%# Eval("HalftimeResult")%>'
                                                    ...
                                                    <asp:TextBox ID="tbBQCSPFResult" runat="server" Text='<%# Eval("BQCSPFResult")%>'
                                                        Visible="false"></asp:TextBox>
                                                </td>
            ...
            <tr>
                <td style="height: 39px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnGO" runat="server" Text="开奖" AlertText="确信输入无误，并立即开奖吗？"
                        OnClick="btnGO_Click" Visible="false" />
                </td>
            </tr>
            <tr>
                <td style="height: 39px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnGO_Step1" runat="server" Text="开奖1" OnClick="btnGO_Step1_Click" />
                    &nbsp;
                    <ShoveWebUI:ShoveConfirmButton ID="btnGO_Step2" Enabled="false" runat="server" Text="开奖2"
                        OnClick="btnGO_Step2_Click" />
                    &nbsp;
                    <ShoveWebUI:ShoveConfirmButton ID="btnGO_Step3" Enabled="false" runat="server" Text="开奖3"
                        OnClick="btnGO_Step3_Click" />
                </td>
            </tr>
            <tr>
                <td align="center">
