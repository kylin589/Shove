<%@ page language="C#" autoeventwireup="true" inherits="Admin_SoftKey, App_Web_mq7qcqnw" enableEventValidation="false" %>
    ...
    <div>
        <table align="center" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbKeyOK" runat="server" Width="300px" TextMode="Password"></asp:TextBox>
                </td>
            </tr>
            <tr>
