<%@ page language="C#" autoeventwireup="true" inherits="Admin_UserDistillUnsuccess, App_Web__1orsh4m" enableEventValidation="false" %>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="baseTab">
        <tr>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="操作">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            拒绝原因:<asp:TextBox ID="tbMemo" runat="server" MaxLength="50" Height="16px" Width="80" />
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                </Columns>
