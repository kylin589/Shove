<%@ page language="C#" autoeventwireup="true" inherits="Admin_RecallingRecord, App_Web__1orsh4m" enableEventValidation="false" %>
...
<body class="center">
    ...
    <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
        <tr style="text-align: left; height: 28px;" class="title">
            <td>
