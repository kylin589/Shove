<%@ page language="C#" autoeventwireup="true" inherits="Admin_InputWinNumber, App_Web_mq7qcqnw" enableEventValidation="false" %>
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr style="height:28px" class="title">
                <td>
                    ...
                    <span style="margin-left:30px;">
                        <a href="InputWinNumber2.aspx" style="color:Red">录入未开启彩种开奖号码</a>
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center" style="height: 60px">
                    <ShoveWebUI:ShoveConfirmButton ID="btnGO" runat="server" Text="保存" AlertText="确信输入无误，并立即保存吗？" OnClick="btnGO_Click" />
                </td>
            </tr>
        </table>
    </div>
