<%@ page language="C#" autoeventwireup="true" inherits="Admin_Jczcgg, App_Web__1orsh4m" enableEventValidation="false" %>
                        ...
                        <ItemTemplate>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td width="20%">
                                        <a href='JczcggEdit.aspx?ID=<%# DataBinder.Eval(Container.DataItem,"ID")%>'>修改</a>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
