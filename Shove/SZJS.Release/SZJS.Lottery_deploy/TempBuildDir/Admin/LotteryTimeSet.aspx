<%@ page language="C#" autoeventwireup="true" inherits="Admin_LotteryTimeSet, App_Web__1orsh4m" enableEventValidation="false" %>
...
<body class="center">
    ...
    <div> <div class="title">
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr>
                <td align="center">
                    <asp:DataGrid ID="g" runat="server" Width="100%" BorderColor="#E0E0E0" BorderStyle="None"
