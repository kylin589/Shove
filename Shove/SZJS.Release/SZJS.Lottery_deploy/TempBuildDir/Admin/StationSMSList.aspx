<%@ page language="C#" autoeventwireup="true" inherits="Admin_StationSMSList, App_Web_mq7qcqnw" enableEventValidation="false" %>
            ...
            <tr>
                <td align="center">
                    <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="0"
                        ...
                        PageSize="30" AllowPaging="True" AllowSorting="True" OnItemCommand="g_ItemCommand"
                        OnItemCreated="g_ItemCreated" OnItemDataBound="g_ItemDataBound">
                        <FooterStyle ForeColor="#330099" BackColor="#FFFFCC"></FooterStyle>
                        <SelectedItemStyle Font-Bold="True" ForeColor="#663399"></SelectedItemStyle>
                        <HeaderStyle HorizontalAlign="Center" ForeColor="RoyalBlue" VerticalAlign="Middle"
                            BackColor="Silver"></HeaderStyle>
                        <Columns>
                            <asp:HyperLinkColumn DataNavigateUrlField="SourceID" DataNavigateUrlFormatString="UserDetail.aspx?id={0}"
                                DataTextField="SourceUserName" SortExpression="SourceUserName" HeaderText="发言人">
                                <HeaderStyle HorizontalAlign="Center" Width="10%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:HyperLinkColumn>
                            <asp:HyperLinkColumn DataNavigateUrlField="AimID" DataNavigateUrlFormatString="UserDetail.aspx?id={0}"
                                DataTextField="AimUserName" SortExpression="AimUserName" HeaderText="接收人">
                                <HeaderStyle HorizontalAlign="Center" Width="10%"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:HyperLinkColumn>
                            ...
                            <asp:TemplateColumn HeaderText="删除">
                                ...
                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                <ItemTemplate>
                                    <ShoveWebUI:ShoveConfirmButton ID="btnDel" runat="server" CommandName="Del" Text="删除"
                                        AlertText="确定要删除此条短消息吗？" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
