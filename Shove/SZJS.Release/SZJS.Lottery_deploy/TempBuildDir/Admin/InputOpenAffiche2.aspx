<%@ page language="C#" autoeventwireup="true" inherits="Admin_InputOpenAffiche2, App_Web_mq7qcqnw" validaterequest="false" enableEventValidation="false" %>
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr class="title" style="height: 28px">
                <td>
                    ...
                    <span style="margin-left: 30px;"><a href="InputOpenAffiche.aspx" style="color: Red">
                        录入已开启彩种开奖公告</a></span>
                </td>
            </tr>
            <tr>
