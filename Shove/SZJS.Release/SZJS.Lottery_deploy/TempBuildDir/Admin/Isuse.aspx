<%@ page language="C#" autoeventwireup="true" inherits="Admin_Isuse, App_Web__1orsh4m" enableEventValidation="false" %>
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr class="title" align="left" style="height: 28px">
                <td>
                    ...
                    <span style="margin-left: 30px;"><a href="Isuse2.aspx" style="color:Red">录入未开启彩种期号</a> </span>
                </td>
            </tr>
            <tr>
                <td align="center">
