<%@ page language="C#" autoeventwireup="true" inherits="Admin_Options, App_Web_mq7qcqnw" enableEventValidation="false" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" Style="z-index: 104; left: 32px; position: absolute; top:40px"
        ...
        <asp:Label ID="Label49" runat="server" Style="z-index: 129; left: 697px; position: absolute;
            top: 378px; right: 450px; width: 60px;">顶值金额：</asp:Label>
        ...
        <asp:Label ID="Label13" runat="server" ForeColor="Red" Style="z-index: 129; left: 442px;
            position: absolute; top:10px">(系统重要参数，请谨慎设置)</asp:Label>
        ...
        <asp:TextBox ID="tbPromotionMemberBonusScale" runat="server" Style="z-index: 118;
            left: 215px; position: absolute; top: 920px" Width="74px" MaxLength="10"></asp:TextBox>
        ...
        <ShoveWebUI:ShoveConfirmButton ID="btnOK" Style="z-index: 101; left: 374px; position: absolute;
            top: 1405px" runat="server" Text="保存" AlertText="确认书写无误吗？" OnClick="btnOK_Click" />
