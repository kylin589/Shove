<%@ page language="C#" autoeventwireup="true" inherits="Admin_FinanceBalance, App_Web_mq7qcqnw" enableEventValidation="false" %>
    ...
    <div>
        ...
        <table cellspacing="1" cellpadding="0" width="100%" border="0" class="baseTab">
            <tr class="title" style="height: 28px">
                <td>
                    &nbsp;<asp:DropDownList ID="ddlYear" runat="server" Width="88px" AutoPostBack="True"
