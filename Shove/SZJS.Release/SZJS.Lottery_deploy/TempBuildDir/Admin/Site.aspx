<%@ page language="C#" autoeventwireup="true" inherits="Admin_Site, App_Web_mq7qcqnw" enableEventValidation="false" %>
...
<body>
    ...
    <div>
        ...
        <table width="950" height="151" border="0" align="center" cellpadding="0" cellspacing="1"
            bgcolor="#85BDE2" style="color: #000000">
            <tr>
                <td colspan="4" bgcolor="#FFFFFF" style="height: 27px; padding-left:44px">
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF">
                    <div align="left">
                        ...
                        <span style="color: #ff0000">用","分隔多个号码</span></div>
                </td>
            </tr>
            <tr>
                <td height="27" bgcolor="#FFFFFF" style="width: 115px">
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF" style="width: 212px">
                    <asp:TextBox ID="tbBonusScale" runat="server" Enabled="False"></asp:TextBox>
                </td>
                <td bgcolor="#FFFFFF" style="width: 105px">
                    <div align="right">
                        最大子站点数：</div>
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF" colspan="3" align="center">
                    <asp:GridView ID="g2" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="Solid"
                        BorderWidth="1px" CellPadding="0" ForeColor="#333333" GridLines="None">
                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                        <Columns>
                            <asp:BoundField DataField="Name" HeaderText="彩种" />
