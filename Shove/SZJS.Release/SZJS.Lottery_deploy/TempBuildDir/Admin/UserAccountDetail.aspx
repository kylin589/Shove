<%@ page language="C#" autoeventwireup="true" inherits="Admin_UserAccountDetail, App_Web_mq7qcqnw" enableEventValidation="false" %>
...
<body class="center">
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="baseTab">
            ...
            <tr class="title" style="height: 28px; text-align: left">
                <td>
                    &nbsp;用户名：
                    ...
                    &nbsp;
                    <asp:Button ID="btnRead" runat="server" Text="读取数据" Width="78px" OnClick="btnRead_Click">
                    </asp:Button>
                    ...
                    <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        <Columns>
                            <asp:TemplateColumn HeaderText="时间">
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DateTime") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="摘要">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblMemo" Text='<%# DataBinder.Eval(Container, "DataItem.Memo") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                </FooterTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="收入(元)">
                                <ItemTemplate>
                                    <asp:Label ID="lblIn" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MoneyAdd") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                </FooterTemplate>
                                <HeaderStyle Width="7%" />
                            ...
                            <asp:TemplateColumn HeaderText="支出(元)">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.MoneySub") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateColumn Visible="false">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="Label7" Text='<%# DataBinder.Eval(Container, "DataItem.SchemeID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
