<%@ page language="C#" autoeventwireup="true" inherits="Admin_Questions, App_Web_mq7qcqnw" enableEventValidation="false" %>
    ...
    <div>
        ...
        <table cellspacing="1" cellpadding="0" width="100%" border="0" class="baseTab">
            <tr class="title" style="height: 28px;">
                <td align="left">
                    &nbsp;<asp:RadioButton ID="rb1" runat="server" Text="全部问题" GroupName="Q" AutoPostBack="True"
                        OnCheckedChanged="rb1_CheckedChanged"></asp:RadioButton>
                    <asp:RadioButton ID="rb2" runat="server" Text="已处理问题" GroupName="Q" AutoPostBack="True"
                        OnCheckedChanged="rb1_CheckedChanged"></asp:RadioButton>
                    <asp:RadioButton ID="rb3" runat="server" Text="未处理问题" Checked="True" GroupName="Q"
                        AutoPostBack="True" OnCheckedChanged="rb1_CheckedChanged"></asp:RadioButton><font
                            face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 问题类型：</font>
            ...
            <tr>
                <td align="center">
                    <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        Font-Names="宋体" PageSize="30" AllowPaging="True" AllowSorting="True" OnItemDataBound="g_ItemDataBound"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn Visible="False" DataField="AnswerStatus" SortExpression="AnswerStatus">
                            </asp:BoundColumn>
                        </Columns>
