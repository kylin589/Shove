<%@ page language="C#" autoeventwireup="true" inherits="Admin_PrintOutput, App_Web__1orsh4m" enableEventValidation="false" %>
            ...
            <tr>
                <td>
                    <font face="宋体">选择彩票类型
                        ...
                        &nbsp;
                        <ShoveWebUI:ShoveConfirmButton ID="btnRefresh" runat="server" Text="刷新" OnClick="btnRefresh_Click" /></font>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <asp:DataList ID="g" runat="server" Width="100%" OnItemCommand="g_ItemCommand" OnItemDataBound="g_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td width="6%">
                                        <ShoveWebUI:ShoveConfirmButton ID="btnBuy" runat="server" Text="出票" CommandName="btnBuy"
                                            AlertText="确认立即出票吗？" />
                                        <ShoveWebUI:ShoveConfirmButton ID="btnSerach" runat="server" Text="票查询" CommandName="btnSerach"
                                            AlertText="确认立即票查询吗？" />
                        ...
                        <asp:Panel ID="panel1" runat="server">
                            <ShoveWebUI:ShoveConfirmButton ID="btnBuyAll" runat="server" AlertText="确认立即全部出票吗？"
                                Text="全部出票" OnClick="btnBuyAll_Click" />
                            (全部出票将不输入彩票标识)</asp:Panel>
                    </font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="td4">
                    <font face="宋体"><strong>满员方案批量下载为 txt 文件，供第三方软件分析、打印使用：
                        <asp:LinkButton ID="btnDownload_txt" runat="server" Enabled="False" OnClick="btnDownload_txt_Click">下载 txt 文件</asp:LinkButton></strong></font>
                </td>
            </tr>
        </table>
        <br />
