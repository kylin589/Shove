<%@ page language="C#" autoeventwireup="true" inherits="Admin_FinanceWin, App_Web__1orsh4m" enableEventValidation="false" %>
                ...
                <td align="center">
                    <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkColumn DataNavigateUrlField="SchemeID" HeaderText="方案" Target="_blank"
                                Text="查看方案" DataNavigateUrlFormatString="../Home/Room/Scheme.aspx?id={0}"></asp:HyperLinkColumn>
