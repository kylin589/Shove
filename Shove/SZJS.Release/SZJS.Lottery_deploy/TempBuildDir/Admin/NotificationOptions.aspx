<%@ page language="C#" autoeventwireup="true" inherits="Admin_NotificationOptions, App_Web_mq7qcqnw" enableEventValidation="false" %>
...
<body>
    ...
    <div>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#85BDE2"
            style="color: #000000; height: 160px;">
            <tr>
            ...
            <tr>
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb3_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb4_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb5_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb6_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb7_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb8_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb9_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb10_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb11_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb12_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb13_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb14_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb15_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb16_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb17_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb18_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb19_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb20_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
                <td height="26" bgcolor="#FFFFFF" style="width: 396px">
                ...
                <td bgcolor="#FFFFFF">
                    ...
                    <asp:CheckBox ID="cb21_3" runat="server" Text="发送站内信" />
                </td>
            </tr>
            <tr>
