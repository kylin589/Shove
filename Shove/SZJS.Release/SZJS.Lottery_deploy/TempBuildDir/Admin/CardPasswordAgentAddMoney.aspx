<%@ page language="C#" autoeventwireup="true" inherits="Admin_CardPasswordAgentAddMoney, App_Web__1orsh4m" enableEventValidation="false" %>
            ...
            <tr class="title">
                <td>
                    ...
                    <asp:Label ID="Label1" Style="z-index: 103; left: 69px; position: absolute; top: 99px;
                        right: 803px;" runat="server">商户编号</asp:Label>
                    ...
                    <asp:Label ID="Label15" Style="z-index: 105; left: 16px; position: absolute; top: 14px"
                        ...
                        Font-Names="黑体">为卡密商户手工充值</asp:Label>
                    &nbsp;
