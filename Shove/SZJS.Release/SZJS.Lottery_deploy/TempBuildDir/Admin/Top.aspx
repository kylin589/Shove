<%@ page language="C#" autoeventwireup="true" inherits="Admin_Top, App_Web__1orsh4m" enableEventValidation="false" %>
                        ...
                        <dl class="quicklist">
                            ...
                            <dd>
                                <a href="../Index.aspx" target="_blank">
                                    ...
                                    购彩首页</a></dd>
                            <dd>
                                <a onclick="return confirm('确定退出后台管理系统?');" href="../UserLogin.aspx" target="_parent">
