<%@ page language="C#" autoeventwireup="true" inherits="Admin_SendSMSList, App_Web_mq7qcqnw" enableEventValidation="false" %>
    ...
    <div>
        ...
        <table id="Table1" cellspacing="1" cellpadding="0" width="100%" class="baseTab" border="0">
            <tr class="title" style="height: 28px;">
                <td>
                    <asp:DropDownList ID="ddlDateTime" runat="server" AutoPostBack="True" Width="152px"
            ...
            <tr>
                <td align="center">
                    <asp:DataGrid ID="g" runat="server" Width="100%" AllowPaging="True" PageSize="30"
                        AutoGenerateColumns="False" CellPadding="0" BackColor="White" BorderWidth="2px"
