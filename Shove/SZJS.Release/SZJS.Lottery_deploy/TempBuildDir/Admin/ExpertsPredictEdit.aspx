<%@ page language="C#" autoeventwireup="true" inherits="Admin_ExpertsPredictEdit, App_Web__1orsh4m" enableEventValidation="false" %>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" class="baseTab" border="0">
            ...
            <tr>
                ...
                <td align="left" style="padding-left: 52px;">
                    用 户 名：
                    <asp:TextBox ID="tbName" runat="server" Width="141px" MaxLength="150"></asp:TextBox>
