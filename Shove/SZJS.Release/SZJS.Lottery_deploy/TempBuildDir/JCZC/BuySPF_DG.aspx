<%@ page language="C#" autoeventwireup="true" inherits="JCZC_BuySPF_DG, App_Web_giir6iew" enableEventValidation="false" %>
...
<body>
    ...
    <div id="gc_bg">
        ...
        <div id="wrap">
            <div class="nav_button">
                <ul>
                    <li class="butt1"><a href="BuySPF.aspx">
                        让球胜平负</a></li>
    ...
    <div class="fsds">
      ...
      <input type="radio" onclick="window.location.href='BuySPF.aspx'">
