<%@ page language="C#" autoeventwireup="true" inherits="JCZC_BuyZJQS_DG, App_Web_giir6iew" enableEventValidation="false" %>
...
<body>
    ...
    <div class="fsds">
      ...
      <input type="radio" onclick="window.location.href='BuyZJQS.aspx'">
