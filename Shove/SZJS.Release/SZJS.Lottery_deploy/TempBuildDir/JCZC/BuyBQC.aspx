<%@ page language="C#" autoeventwireup="true" inherits="JCZC_BuyBQC, App_Web_giir6iew" enableEventValidation="false" %>
...
<body>
    <form id="buy_form" runat="server" ajax="Buy_Handler.ashx">
     <uc1:WebHead ID="WebHead" runat="server" />
    <div id="gc_bg">
        <div id="position">
                ...
                <ul>
                   <li class="butt2"><a href="BuySPF.aspx">
                    ...
                    <li class="butt2"><a href="BuyZQBF.aspx">
                        比分</a></li>
                    <li class="butt1"><a href="BuyBQC.aspx">
                        半全场</a></li>
    ...
    <div class="fsds">
      <div class="l">
      <input type="radio"  onclick="window.location.href='BuyBQC_DG.aspx'" />
      ...
      <tr>
        ...
        <div class="touz_btn"><img src="Images/btn_dg.gif" id="dgBtn" border="0" style="cursor: pointer;" alt="确认代购"></div>	</td>
                ...
                <div class="sg_text01">
                    ...
                    <span>1、单个方案最多只能选择3场赛事进行投注。</span><br />
                    <span>2、表中所有固定奖金额仅供参考，2或3场过关投注，单注最高奖金限额20万元。</span><br />
        ...
        <input type="hidden" id="playname" name="playname" value="半全场" />
