<%@ page language="C#" autoeventwireup="true" inherits="JCZC_BuyBQC_DG, App_Web_giir6iew" enableEventValidation="false" %>
...
<body>
    ...
    <div class="fsds">
      ...
      <input type="radio" onclick="window.location.href='BuyBQC.aspx'">
...
<input type="hidden" id="playname" name="playname" value="半全场胜平负" />
