<%@ page language="C#" autoeventwireup="true" inherits="CPS_Admin_BonusScaleView, App_Web_xh7rtory" enableEventValidation="false" %>
            ...
            <div class="right">
                ...
                <div class="cen">
                    ...
                    <asp:DataGrid ID="g" runat="server" BorderStyle="None" AllowSorting="True" AllowPaging="True"
                        ...
                        CellSpacing="1" GridLines="None" DataKeyField="LotteryID">
