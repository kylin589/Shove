<%@ page language="C#" autoeventwireup="true" inherits="CPS_Admin_ImageCode, App_Web_xh7rtory" enableEventValidation="false" %>
        ...
        <div class="homecen">
            <div class="left">
                ...
                <ul id="trPromoterCPS" runat="server">
                    <li><a href="ImageCode.aspx" class="hover">图片广告样式</a></li>
                    <li><a href="WordCode.aspx">文字标题广告样式</a></li></ul>
            </div>
            <div class="right">
                <div class="top">
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <input type="button" onclick="doufucopy('tbImageCode1')" value="复制代码" class="btn" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="15%" bgcolor="#FFFFFF">
                                    <input type="button" onclick="doufucopy('tbImageCode2')" value="复制代码" class="btn" />
                                </td>
                            </tr>
                            <tr>
                                <td height="30" align="center" bgcolor="#FCF5E1">
