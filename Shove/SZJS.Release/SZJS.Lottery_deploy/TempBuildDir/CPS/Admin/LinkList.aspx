<%@ page language="C#" autoeventwireup="true" inherits="CPS_Admin_LinkList, App_Web_xh7rtory" enableEventValidation="false" %>
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
                        <tr>
                            <td height="30" colspan="2" align="center" bgcolor="#EAF2FE">
                                <strong class="blue12">推广链接列表</strong>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="left" bgcolor="#FFFFFF" class="hui" style="padding: 10px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="120">
                                            <asp:TextBox runat="server" ID="tbBeginTime" onblur="if(this.value=='') this.value=document.getElementById('hBeginTime').value"
                                                name="tbBeginTime" onFocus="WdatePicker({el:'tbBeginTime',dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})"  CssClass="text"/>
                                        </td>
                                        <td width="83" align="right">
                                            截止时间：
                                        </td>
                                        <td width="137">
                                            <asp:TextBox runat="server" ID="tbEndTime" onblur="if(this.value=='') this.value=document.getElementById('hEndTime').value"
                                                name="tbEndTime" onFocus="WdatePicker({el:'tbEndTime',dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})"  CssClass="text"/>
                                        </td>
                                        <td width="229">
