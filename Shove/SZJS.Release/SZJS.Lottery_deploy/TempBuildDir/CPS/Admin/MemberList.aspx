<%@ page language="C#" autoeventwireup="true" inherits="CPS_Admin_MemberList, App_Web_xh7rtory" enableEventValidation="false" %>
                            ...
                            <td colspan="2" align="left" bgcolor="#FFFFFF" class="hui" style="padding: 10px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="120">
                                            <asp:TextBox runat="server" ID="tbBeginTime" CssClass="text" onblur="if(this.value=='') this.value=document.getElementById('hBeginTime').value"
                                        ...
                                        <td width="137">
                                            <asp:TextBox runat="server" ID="tbEndTime" CssClass="text" onblur="if(this.value=='') this.value=document.getElementById('hEndTime').value"
                                ...
                                <asp:DataGrid ID="g" runat="server" Width="100%" BorderStyle="None" AllowSorting="True"
                                    ...
                                    BackColor="#CCCCCC" Font-Names="宋体" CellSpacing="1" GridLines="None" OnItemCommand="g_ItemCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="TradeMoney" HeaderText="消费总额" DataFormatString="{0:N}">
                                            ...
                                            <ItemStyle Width="17%" CssClass="hui" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="BonusMoney" HeaderText="分润总额" DataFormatString="{0:N}">
                                            <HeaderStyle Width="17%" />
                                            <ItemStyle Width="17%" CssClass="hui" />
                                        </asp:BoundColumn>
                                        <asp:TemplateColumn HeaderText="购买明细">
                                            <HeaderStyle Width="15%" />
                                            <ItemStyle Width="15%" CssClass="red" />
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btnDetaile" runat="server" CommandName="BuyDetail">查看</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
