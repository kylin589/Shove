<%@ page language="C#" autoeventwireup="true" inherits="CPS_CpsRegAgree, App_Web_k8mvz58m" enableEventValidation="false" %>
...
<body>
    ...
    <div class="daohang2">
        您现在位置:兼职推广首页 >> 推广员注册协议</div>
    <div class="daohang3">
        <a href="UserRegCPS.aspx">注册推广员 </a><a href="UserRegCPS.aspx?type=2">注册代理商 </a><a
            href="Login.aspx">推广员登录 </a><a href="CpsRegAgree.aspx">注册协议 </a>
    </div>
    <div class="denglu tui2">
        <div class="delu" id="labAgreement" runat="server">
        </div>
    </div>
