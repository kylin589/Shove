<%@ page language="C#" autoeventwireup="true" inherits="CPS_Administrator_BaseInfo, App_Web_mmkwpj80" enableEventValidation="false" %>
...
<body style="background-image: url(about:blank);">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
            <td height="30" align="center" bgcolor="#E9F1F8"  style="padding-left: 10px;
                padding-right: 10px;">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="baseTab">
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                <tr>
                                    <td width="12%" height="28" align="right" bgcolor="#F7F7F7" >
                                        CPS 模式：
                                    </td>
                                ...
                                <tr>
                                    <td height="28" align="right" bgcolor="#F7F7F7" >
                                        推广地址：
                                    </td>
                                    <td bgcolor="#FFFFFF" class="blue" style="padding-left: 10px;">
                                        <asp:TextBox ID="tbDomainName" runat="server" Enabled="false" autocomplete="off"
                                            Width="650px" Height="20px" ForeColor="#CC0000" />
                                    </td>
                                </tr>
                                <tr id="trMD5Key" runat="server" visible="false">
                                    ...
                                    <td bgcolor="#FFFFFF" style="padding-left: 10px;">
                                        <asp:TextBox ID="tbMD5Key" CssClass="in_text_hui" runat="server" autocomplete="off"
                                            MaxLength="64" />
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" class="blue" style="padding-left: 10px;">
                                        <asp:HyperLink ID="linkBonusScale" runat="server" Target="_self" Font-Underline="True"
                                            ForeColor="#CC0000">查看/设置返点比例</asp:HyperLink>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                ...
                                <tr>
                                    <td width="12%" align="right" bgcolor="#F7F7F7" >
                                        联系人：
                                    </td>
                                    <td bgcolor="#FFFFFF" style="padding-left: 10px;">
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#FFFFFF" style="padding-left: 10px;">
                                        <asp:TextBox ID="tbEmail" CssClass="in_text_hui" runat="server" autocomplete="off" /><span
