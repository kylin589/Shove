<%@ page language="C#" autoeventwireup="true" inherits="CPS_Administrator_UserDistill, App_Web_mmkwpj80" enableEventValidation="false" %>
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tr>
                                        <td style="height: 19px" align="left">
                                            ...
                                            <span id="Span1" class='<%# DataBinder.Eval(Container.DataItem,"BankName").ToString()==""?"hidden":"visibility" %>'
                                                runat="server">开户银行&nbsp;<font color="#ff0000"><%# DataBinder.Eval(Container.DataItem,"BankTypeName")%></font>&nbsp;
                                            ...
                                            </span><span id="Span2" class='<%# DataBinder.Eval(Container.DataItem,"AlipayName").ToString().Trim()==""?"hidden":"visibility"%>'
                                                runat="server">支付宝ID&nbsp;<font color="#ff0000"><%# DataBinder.Eval(Container.DataItem,"AlipayID") %></font>&nbsp;
                                                支付宝用户名&nbsp;<font color="#ff0000"><%# DataBinder.Eval(Container.DataItem, "AlipayName")%></font>&nbsp;
                                            </span><span id="Span3" class='<%# DataBinder.Eval(Container.DataItem,"BillName").ToString().Trim()==""?"hidden":"visibility"%>'
                                                runat="server">快钱用户名&nbsp;<font color="#ff0000"><%# DataBinder.Eval(Container.DataItem, "BillName")%></font>&nbsp;
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
