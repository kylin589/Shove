<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuyDF6J1, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuyDF6J1.js" type="text/javascript"></script>

</head>
<body onload="clickPlayType(5801);">
    ...
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/logo_58.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>东方6+1</span>：2元赢取<span>￥500万</span></h1>
                        <a href="../Help/play5.aspx">玩法介绍</a><a href="../TrendCharts/DF6J1/DF61_ZHFB.aspx">走势图</a><a
                            href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        每日20:30开奖 <em id="currIsuseName"></em><br/>
            ...
            <div class="main2">
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div id="tagContent0">
                            <div class="tag_input">
                                <input type='radio' name='playType' id='playType5801' value='5801' checked='checked'
                                    onclick='clickPlayType(this.value)' /><span>单式</span>
                                <input type='radio' name='playType' id='playType5802' value='5802' onclick='clickPlayType(this.value)' /><span>复式</span>
                            </div>
                            <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" frameborder="0"
                                height="400" scrolling="no" onload="document.getElementById('iframe_playtypes').style.height=iframe_playtypes.document.body.scrollHeight;">
                            </iframe>
                        </div>
        ...
        <div class="right">
            ...
            <div class="rmain1">
                <div class="title">
                    <h1>
                        东方6+1新闻</h1>
                    <a href="../SiteNews/NewList.aspx?TypeId=101009">更多</a></div>
                <div class="neirong">
                    <ul>
