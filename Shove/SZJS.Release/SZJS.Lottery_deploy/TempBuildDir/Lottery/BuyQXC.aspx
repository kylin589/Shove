<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuyQXC, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuyQXC.js" type="text/javascript"></script>

</head>
<body onload="clickPlayType(301);">
    ...
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/qxc_logo.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>七星彩</span>：两元赢取<span>￥500万</span></h1>
                        <a href="../Help/play6.aspx">玩法介绍</a><a href="../TrendCharts/7Xing/7X_HMFB.aspx">走势图</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        每周二，五，日晚20:30开奖 <em>第<span id="currIsuseName" ></span>期</em><br/>
            ...
            <div class="main2">
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div class="tagContent selectTag" id="tagContent0" style="height:430px">
                            <div class="tag_input">
                                <input type='radio' name='playType' id='playType301' value='301' checked='checked'
                                    onclick='clickPlayType(this.value)' /><span>单式</span>
                                <input type='radio' name='playType' id='playType302' value='302' onclick='clickPlayType(this.value)' /><span>复式</span>
                            </div> 
                            <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" frameborder="0" height="100%"
                                height="300" scrolling="no" onload="document.getElementById('iframe_playtypes').style.height=iframe_playtypes.document.body.scrollHeight;">
                            </iframe>
                        </div>
