<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuyPL5, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuyPL5.js" type="text/javascript"></script>
</head>
<body onload="clickPlayType(6401);">
    <form id="form1" runat="server">
<input id="tbPlayTypeID" name="tbPlayTypeID" type="hidden" value="6401" />
    ...
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img id="LotteryImg" src="../Home/Room/Images/logo_64.gif" alt="排列5" />
                <dl>
                    <dt>
                    <h1 class='blue18' style="display: inline;">
                                <span>排列5</span>：两元赢取<span>￥10万</span></h1></h1>
                       <a href="../Help/play10.aspx">玩法介绍</a><a href="../TrendCharts/PL5/PL5_KJFB.aspx">走势图</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                ...
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div class="tagContent selectTag" id="tagContent0">
                            <div class="tag_input">
                                <input type='radio' checked="checked" name='playType' id='playType6401' value='6401' onclick='clickPlayType(this.value)' /><span>单式</span>
                                    <input type='radio' name='playType' id='playType6402' value='6402' onclick='clickPlayType(this.value)' /><span>复式</span>
                            </div>
