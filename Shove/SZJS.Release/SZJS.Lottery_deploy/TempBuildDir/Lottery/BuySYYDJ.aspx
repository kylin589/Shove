<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuySYYDJ, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuySYYDJ.js" type="text/javascript"></script>
        <script src="../JavaScript/jquery-1.4.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function() {
 
            $(".bb").click(function() { $("#Con").css("height", "265px") });
            $(".aa").click(function() { $("#Con").css("height", "245px") });
            $(".cc").click(function() { $("#Con").css("height", "300px") });
        })
    </script>
    
</head>
<body onload="clickPlayType(6201);">
    ...
    <uc1:Head ID="Head1" runat="server" />
     ...
     <div class="wrap">
        <div class="left">
             <div class="main1">
                <img alt="" src="../Home/Room/Images/logo_70.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>十一运夺金</span>：两元赢取<span>￥1170元</span></h1>
                        <a href="../Help/play17.aspx">玩法介绍</a><a href="../TrendCharts/SYYDJ/SYDJ_FBZS.aspx">走势图</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        每天65期<em><em id="currIsuseName"></em></em><br />
                        <span id="spanWin">投注截止:<span id="toOpenIsuseTime"></span></span>
                        <span id="spanShowInfo"/> 离投注截止还有:<span id="toCurrIsuseEndTime" style="color:Red"></span>
                   </dd>
            ...
            <div class="main2">
                <div id="cons">
                    ...
                    <div id="tagContent">
                          <div id="tagContent0">
                            <div class="tag_input" id="Con" style="height:245px;">
                                <ul id="Cons" style="padding-left: 60px;">
                                    <li class="selectCon"><a onclick="selectCon('0',this);clickPlayType('6201');"  href="javascript:void(0)">
                                        任选1</a></li>
                                    ...
                                    <li><a onclick="selectCon('7',this);clickPlayType('6208');" href="javascript:void(0)" class="aa">任选8</a></li>
                                ...
                                <div id="ConContent">
                                    <div class="ConContent selectCon" id="Content0">
                                        <div class="tag_input">
                                           <input type='radio' name='playType' id='playType62001' value='6201' checked='checked' onclick='clickPlayType(this.value)'/><span>复式</span>  
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content1">
                                        <div class="tag_input">
                                            <input type='radio' name='playType' id='playType62101' value='6202' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                            <input type='radio' name='playType' id='playType62102' value='62022' onclick='clickPlayType(this.value)'  class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content2">
                                        <div class="tag_input">
                                            <input type='radio' name='playType' id='playType62201' value='6203' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                            <input type='radio' name='playType' id='playType62202' value='62033' onclick='clickPlayType(this.value)' class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content3">
                                        <div class="tag_input">
                                             <input type='radio' name='playType' id='playType62301' value='6204' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                             <input type='radio' name='playType' id='playType62302' value='62044' onclick='clickPlayType(this.value)' class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content4">
                                        <div class="tag_input">
                                            <input type='radio' name='playType' id='playType62401' value='6205' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                            <input type='radio' name='playType' id='playType62402' value='62055' onclick='clickPlayType(this.value)' class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content5">
                                        <div class="tag_input">
                                           <input type='radio' name='playType' id='playType62501' value='6206' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                           <input type='radio' name='playType' id='playType62502' value='62066' onclick='clickPlayType(this.value)' class="bb" /><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content6">
                                        <div class="tag_input">
                                            <input type='radio' name='playType' id='playType62601' value='6207' onclick='clickPlayType(this.value)' class="aa"/><span>复式</span>
                                            <input type='radio' name='playType' id='playType62602' value='62077' onclick='clickPlayType(this.value)' class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content7">
                                        <div class="tag_input">
                                           <input type='radio' name='playType' id='playType62701' value='6208' onclick='clickPlayType(this.value)' /><span>复式</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content8">
                                        <div class="tag_input">
                                             <input type='radio' name='playType' id='playType62801' value='6210' onclick='clickPlayType(this.value)' class="cc"/><span>直选</span>
                                             <input type='radio' name='playType' id='playType62802' value='6213' onclick='clickPlayType(this.value)' class="cc"/><span>复选</span>
                                             <input type='radio' name='playType' id='playType62803' value='6212' onclick='clickPlayType(this.value)'  class="aa"/><span>组选</span>
                                             <input type='radio' name='playType' id='playType62804' value='62122' onclick='clickPlayType(this.value)'  class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div class="ConContent" id="Content9">
                                        <div class="tag_input">
                                             <input type='radio' name='playType' id='playType62901' value='6209' onclick='clickPlayType(this.value)' class="bb"/><span>直选</span>
                                             <input type='radio' name='playType' id='playType62902' value='6214' onclick='clickPlayType(this.value)' class="bb"/><span>复选</span>
                                             <input type='radio' name='playType' id='playType62903' value='6211' onclick='clickPlayType(this.value)'  class="aa"/><span>组选</span>
                                             <input type='radio' name='playType' id='playType62904' value='62111' onclick='clickPlayType(this.value)'  class="bb"/><span>胆拖</span>
                                        </div>
                                    </div>
                                    <div style="height:10px; text-align:left; margin-left:25px; width:600px; display:none "><i id="tdIntroduce"></i></div>
                ...
                <script type="text/javascript">
                 ...
                 // 操作标签
                  ...
                  document.getElementById("Content"+Content).style.display = "block";
                    $Id("playType62" + String(Content) + "01").checked = true;
                   
                    var pts=$Id("playType62" + String(Content) + "01").value;
                    clickPlayType(pts);
                }
                </script>
            </div>
        ...
        <div class="right">
            ...
            <div class="rmain1">
                <div class="title">
                    <h1>
                        十一运夺金新闻</h1>
                    <a href="../SiteNews/NewList.aspx?TypeId=101013">更多</a></div>
                <div class="neirong">
                    <ul>
