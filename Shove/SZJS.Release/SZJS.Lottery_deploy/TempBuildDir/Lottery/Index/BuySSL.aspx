<%@ page language="C#" autoeventwireup="true" inherits="Lottery_Index_BuySSL, App_Web_vj6vhweq" enableEventValidation="false" %>
    ...
    <div id="and5">
        <div id="i_zc_bqc" class="i_zc_container">
            <div class="left_main">
                <div class="quick_buy">
                    <dt class="icon_ssq">
                        <img src="../../Home/Room/Images/logo_29.gif" /></dt>
                    <dd id="tdLuckNumber" runat="server">
                    </dd>
                    <dd>
                        <span>[ 直选 ]从0-9中选3个整数</span></dd>
                    <dd>
                        <span>每日23期，10:30~21:30每半小时开奖</span></dd>
                </div>
                ...
                <p class="shuangseqiu">
                    <span id='currIsuseName'></span><i class="jz_time">截止时间</i> <b><span class="red"
                        id="toCurrIsuseEndTime"></span></b><a href="../BuySSL.aspx" target="_blank">进入专区&gt;&gt;</a><em><span>倍投：
