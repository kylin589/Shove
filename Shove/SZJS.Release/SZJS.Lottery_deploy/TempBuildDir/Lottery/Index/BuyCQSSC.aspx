<%@ page language="C#" autoeventwireup="true" inherits="Lottery_Index_BuyCQSSC, App_Web_vj6vhweq" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="buyCQSSC.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="and5">
        <div id="i_zc_sfr9" class="i_zc_container">
            <div class="left_main">
                <div class="quick_buy">
                    <dt class="icon_ssq">
                        <img src="../../Home/Room/Images/cq_ssc.gif" /></dt>
                    <dd id="tdLuckNumber" runat="server">
                    </dd>
                    <dd>
                        <span>[ 直选 ]从0-9中选5个整数</span></dd>
                    <dd>
                        <span>每日9：00~23:00每10分钟开奖</span></dd>
                </div>
                ...
                <p class="shuangseqiu">
                    <span id='currIsuseName'></span><i class="jz_time">截止时间</i> <b><span class="red"
                        id="toCurrIsuseEndTime"></span></b><a href="../BuySSC.aspx" target="_blank">进入专区&gt;&gt;</a><em><span>倍投：
                            <input type="text" value="1" id="tb_Multiple" maxlength="2" style="ime-mode: disabled;"
                                class="i-a" />
                            倍{最大99倍}</span> </em>
                </p>
            </div>
