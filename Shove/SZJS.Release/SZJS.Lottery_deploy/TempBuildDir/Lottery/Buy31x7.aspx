<%@ page language="C#" autoeventwireup="true" inherits="Lottery_Buy31x7, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    <title>31选7：2元最高可达￥500万-31选7选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    ...
    <script src="../Home/Room/JavaScript/Buy31x7.js" type="text/javascript"></script>

</head>
<body onload="clickPlayType(6501);">
    ...
    <uc2:Head ID="Head1" runat="server" />
            <div style="margin:0 auto; margin-bottom:10px; width:986px;">
             <a href="BuySSL.aspx"> <img src="../Images/ads9.jpg" /></a> </div>
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/logo_65.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>31选7</span>：两元赢取<span>￥500万</span></h1>
                          <a href="../Help/play11.aspx">玩法介绍</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                    
                        每周一，四，六晚21:00开奖 <em>第<span id="currIsuseName" ></span>期</em><br/> 投注截止: <span id="currIsuseEndTime"></span>离投注截止还有:<em
                ...
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div class="tagContent selectTag" id="tagContent0">
                            <div class="tag_input">
                                <input type='radio' onclick='clickPlayType(this.value)' name='playType' id='playType6501'
                                    value='6501' checked='checked' /><span>单式</span>
                                <input type='radio' name='playType' id='playType6502' value='6502' onclick='clickPlayType(this.value)' /><span>复式</span>
                            </div>
                            <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" frameborder="0"
                                height="230" scrolling="no" onload="document.getElementById('iframe_playtypes').style.height=iframe_playtypes.document.body.scrollHeight;">
                            </iframe>
                        </div>
            ...
            <div class="main3" id="tagContent4">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            <td align="right">
                                <select class="txtarea" size="7" id="list_LotteryNumber" style="width: 580px;">
                                </select>
                            </td>
                            <td width="120px">
                                <ul id="touzhu_btns">
            ...
            <div class="main3" id="tagContent5">
                <div class="lot_data">
                    ...
                    <label id="do_chase" class="red for_checkbox">
                        发起合买</label>
                    <input type="checkbox" id="Chase" name="Chase" type="checkbox" onclick="oncbInitiateTypeClick(this);"
                        value="1" />
                    <label id="do_syndicate" class="red for_checkbox">
                        我要追号</label>
                    <span id="multiple_box">倍投：<input type="text" onkeypress="return InputMask_Number();"
                        onblur="CheckMultiple();" class="i-a" value="1" id="tb_Multiple" name="tb_Multiple"
                        maxlength="2" />
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="buy_table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td_content">
                                <p>
                                    当追号任务某期中奖金额达到<input class="i-a" id="tbAutoStopAtWinMoney" name="tbAutoStopAtWinMoney"
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="buy_table">
                    <tbody>
                            ...
                            <td class="td_content">
                                <p>
                                    <input class="i-a" type="text" onkeypress="return InputMask_Number();" id="tb_SchemeBonusScale"
                                        name="tb_SchemeBonusScale" onblur="return SchemeBonusScale();" value="1" />%
                                    佣金比例只能为0~10。
                                </p>
                            </td>
                        </tr>
                            ...
                            <td class="td_content">
                                <p>
                                    <input class="i-a" type="text" onkeypress="return InputMask_Number();" id="tb_Share"
                                        name="tb_Share" onblur="return CheckShare();" value="1" />份，每份 <span id="lab_ShareMoney"
                            ...
                            <td class="td_content">
                                <p>
                                    <input class="i-a" type="text" onkeypress="return InputMask_Number();" id="tb_BuyShare"
                                        name="tb_BuyShare" onblur="return CheckBuyShare();" value="1" />份，金额 <span id="lab_BuyMoney"
                        ...
                        <tr>
                            ...
                            <td class="td_content">
                                <p>
                                    <input class="i-a" onkeypress="return InputMask_Number();" id="tb_AssureShare" name="tb_AssureShare"
                                        onblur="return CheckAssureShare();" value="1" />份，保底 <span id="lab_AssureMoney" style="color: Red">
                                            0.00</span> 元。 【注】保底资金将被暂时冻结,在当期截止销售时、或根据此方案的销售、撤单情况,冻结资金将返还到您的电话投注卡账户中。
                                </p>
                            </td>
                        </tr>
                        <tr>
