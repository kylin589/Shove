<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuySFC_9_D, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuySFC_9_D.js" type="text/javascript"></script>

</head>
<body onload="clickPlayType('7501')">
    <form id="form1" runat="server">
    <input id="tbPlayTypeID" name="tbPlayTypeID" type="hidden" value='7501' />
    ...
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img id="LotteryImg" src="../Home/Room/Images/rx9c_logo.gif" alt="任九场" />
                <dl>
                    <dt>
                        <h1>
                            <span>任九场</span>：两元赢取<span>￥500万</span></h1>
                        <a href="../Help/play14.aspx">玩法介绍</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        不定期开奖 <em id="currIsuseName"></em><br/>
            ...
            <div class="main2">
                <div id="con">
                    <ul id="tags">
                        ...
                        <li id="tag1"><a onclick="newCoBuy(<%=LotteryID %>,<%= Number %>)" href="javascript:void(0)">
                            参与合买</a></li>
                        <li id="tag2"><a onclick="followScheme(<%=LotteryID %>,<%= Number %>)" href="javascript:void(0)">
                            定制跟单</a></li>
                        <li id="tag3"><a onclick="schemeAll(<%=LotteryID %>,<%= Number %>)" href="javascript:void(0)">
                            全部方案</a></li>
                        </li>
                    </ul>
                    <div id="tagContent">
                        <div class="tagContent selectTag" id="tagContent0" style="height: 680px;">
                            <div class="tag_input">
                                <input type='radio' name='playType' id='playType7501' value='7501' checked="checked"
                                    onclick='clickPlayType(this.value)' /><span>单式</span>
                                <input type='radio' name='playType' id='playType7502' value='7502' onclick='clickPlayType(this.value)' /><span>复式</span>
                                <input type='radio' name='playType' id='playType75011' value='75011' onclick='clickPlayType(this.value)'
                                    style="display: none" /><span style="display: none">单式预投</span>
                                <input type='radio' name='playType' id='playType75022' value='75022' onclick='clickPlayType(this.value)'
            ...
            <div class="main3" id="tagContent4">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            <td align="right">
                                <select class="txtarea" size="7" id="list_LotteryNumber" style="width: 580px; height: 147px;"
                                    multiple="multiple">
                                </select>
                            </td>
                            <td width="120px">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="buy_table">
                    <tbody>
                        <tr id="trSchemeMoney" style="display: none">
                            ...
                            <td class="td_content">
                                <input type="text" class="i-a" onkeypress="return InputMask_Number();" id="tb_SchemeMoney"
                                    name="tb_SchemeMoney" onblur="return checkSchemeMoney(this);" value="2" />只能是2的倍数。
                            </td>
                        </tr>
                        <tr>
                            <td class="td_title">
