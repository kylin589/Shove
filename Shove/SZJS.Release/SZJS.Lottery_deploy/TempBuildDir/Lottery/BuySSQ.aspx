<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuySSQ, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    <title>双色球：2元赢取￥1000万-双色球选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    ...
    <script src="../Home/Room/JavaScript/BuySSQ.js" type="text/javascript"></script>
    <link href="../QQ/qq.css" rel="stylesheet" type="text/css" />
    <script src="../QQ/ServiceQQ.htm"></script>
    <link rel="shortcut icon" href="../favicon.ico" />
    <script type="text/javascript">
        $(function() {
            $("#playType501").click(function() { $("#tagContent0").height("305px") });
            $("#playType502").click(function() { $("#tagContent0").height("305px") });
            $("#playType503").click(function() { $("#tagContent0").height("420px") });
            $("#playType504").click(function() { $("#tagContent0").height("305px") });
            
        });
    </script>
</head>
<body onload="clickPlayType(501);">
    ...
    <div class="wrap">
        ...
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/logo_ssq.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>双色球</span>：两元赢取<span>￥1000万</span></h1>
                        <a href="../Help/play1.aspx">玩法介绍</a> <a href="../TrendCharts/SSQ/SSQ_ZHFB.aspx">走势图</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        每周二，四，日晚21:30开奖 <em id="currIsuseName"></em><br/>
            ...
            <div class="main2">
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div id="tagContent0" style="height:305px;">
                            <div class="tag_input">
                                <h1>
                                    直选</h1>
                                <input type='radio' name='playType' id='playType501' value='501' checked='checked'
                                    onclick='clickPlayType(this.value)' /><span>单式</span>
                                <input type='radio' name='playType' id='playType502' value='502' onclick='clickPlayType(this.value)' /><span>复式</span>
                                <input type='radio' name='playType' id='playType503' value='503' onclick='clickPlayType(this.value)' style="display:none" /><span style="display:none">胆拖</span>
                                <input type='radio' name='playType' id='playType504' value='504' onclick='clickPlayType(this.value)' /><span>智能机选</span>
                            </div>

                                                        <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" height="100%" frameborder="0" scrolling="no" onload="document.getElementById('iframe_playtypes').style.height=iframe_playtypes.document.body.scrollHeight;">
                            </iframe>
   </div>
            ...
            <div class="main3" id="tagContent5">
                <div class="lot_data">                <input id="CoBuy" name="CoBuy" type="checkbox" onclick="oncbInitiateTypeClick(this);"
                        value="2">        <label for="do_syndicate" class="red for_checkbox">
                        发起合买</label>
        ...
        <div class="right">
            ...
            <div class="rmain1">
                <div class="title">
                    <h1>
                        双色球新闻</h1>
                    <a href="../SiteNews/NewList.aspx?TypeId=101005">更多</a></div>
                <div class="neirong">
                    <ul>
