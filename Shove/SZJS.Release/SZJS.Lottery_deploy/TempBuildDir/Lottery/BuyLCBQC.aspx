<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuyLCBQC, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuyLCBQC.js" type="text/javascript"></script>
...
<body>
    ...
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/6cbqc_logo.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>六场半全场</span>：两元赢取<span>￥500万</span></h1>
                        <a href="../Help/play13.aspx">玩法介绍</a><a href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        不定期开奖 <em>第<span id="currIsuseName"></span>期</em><br/>
                        投注截止:<span id="currIsuseEndTime"></span>
                        离投注截止还有:<em id="toCurrIsuseEndTime"></em></dd>
                </dl>
            </div>
            <div class="clear">
            </div>
            <div class="main2">
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div id="tagContent0" style="height: 560px">
                            <div class="tag_input">
                                <input type='radio' name='playType' id='playType1501' value='1501' checked='checked'
                                    onclick='clickPlayType(this.value)' /><span>单式</span>
                                <input type='radio' name='playType' id='playType1502' value='1502' onclick='clickPlayType(this.value)' /><span>复式</span>
                                <input type='radio' name='playType' id='playType15011' value='15011' onclick='clickPlayType(this.value)'
                                    style="display: none" /><span style="display: none">单式预投</span>
                                <input type='radio' name='playType' id='playType15022' value='15022' onclick='clickPlayType(this.value)'
            ...
            <div class="main3" id="tagContent4">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>
                            <td align="right">
                                <select class="txtarea" size="7" name="list_LotteryNumber" id="list_LotteryNumber" style="width: 580px; height:147px;" multiple="multiple">
                                </select>
                            </td>
                            <td width="120px">
                                <ul id="touzhu_btns">
            ...
            <div class="mian4" id="trShowJion" style="display: none;">
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="buy_table">
                    <tbody>
                        <tr class="td_title" id="trSchemeMoney" style="display: none;">
                            <td>
                                方案金额
                            </td>
                            <td class="td_content">
                        ...
                        <tr>
                            ...
                            <td class="td_content">
                                ...
                                <p>
                                    【注】您可以选择一些用户作为招股对象，用户名之间用 , 隔开。 如：louis,中个500万,六场半全场高手,...填写错误的用户名、格式不正确、或者没有填写则表示向全部会员招股。
                                </p>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="right">
            ...
            <div class="rmain1">
                <div class="title">
                    <h1>
                        足彩新闻</h1>
                    <a href="../SiteNews/NewList.aspx?TypeId=101004">更多</a></div>
                <div class="neirong">
                    <ul>
    ...
    <uc2:WebFoot ID="WebFoot2" runat="server" />
    </form>
