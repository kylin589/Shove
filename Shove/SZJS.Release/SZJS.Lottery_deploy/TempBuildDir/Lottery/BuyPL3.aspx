<%@ page language="C#" autoeventwireup="true" inherits="Lottery_BuyPL3, App_Web_mg_ktxsi" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script src="../Home/Room/JavaScript/BuyPL3.js" type="text/javascript"></script>
    <script  type="text/javascript">
        $(function() {
        $(".aa").click(function() { $("#tagContent0").css("height", "390px") });
        $(".bb").click(function() { $("#tagContent0").css("height", "390px") })
        $(".cc").click(function() { $("#tagContent0").css("height", "260px") })
        $(".dd").click(function() { $("#tagContent0").css("height", "230px") });
        $(".ee").click(function() { $("#tagContent0").css("height", "390px") });
        $(".ff").click(function() { $("#tagContent0").css("height", "390px") }); ; ;

        })
    </script>

</head>
<body onload="clickPlayType(6301);">
    ...
    <uc1:Head ID="Head1" runat="server" />
        <div style="margin:0 auto; margin-bottom:10px; width:986px;">
             <a href="BuyJX11X5.aspx"> <img src="../Images/ads10.jpg" /></a> </div>
    <div class="wrap">
        <div class="left">
            <div class="main1">
                <img alt="" src="../Home/Room/Images/logo_63.gif" />
                <dl>
                    <dt>
                        <h1>
                            <span>排列三</span>：两元赢取<span>￥1000元</span></h1>
                        <a href="../Help/play9.aspx">玩法介绍</a><a href="../TrendCharts/PL3/PL3_HMFB.aspx">走势图</a><a
                            href="../WinQuery/Default.aspx">中奖查询</a></dt>
                    <dd>
                        每日20:30开奖 <em>第<span id="currIsuseName"></span>期</em><br/>
                        投注截止时间: &nbsp;<span id="currIsuseEndTime"></span>离投注截止还有:<em><span
            ...
            <div class="main2">
                <div id="con">
                    ...
                    <div id="tagContent">
                        <div id="tagContent0" style="height:390px;">
                            <div class="tag_input">
                                <h1>
                                    直选</h1>
                                <input type='radio' name='playType' id='playType6301' value='6301' checked='checked'
                                    onclick='clickPlayType(this.value)'  class="aa"/><span>直选单式</span>
                                <input type='radio' name='playType' id='playType6302' value='6302' onclick='clickPlayType(this.value)' class="bb" /><span>直选复式</span>
                                <input type='radio' name='playType' id='playType6303' value='6303' onclick='clickPlayType(this.value)' class="cc" /><span>组选单式</span>
                                <input type='radio' name='playType' id='playType6304' value='6304' onclick='clickPlayType(this.value)' class="dd"/><span>组选6</span>
                                <input type='radio' name='playType' id='playType6305' value='6305' onclick='clickPlayType(this.value)' class="dd"/><span>组选3</span>
                                <h1>
                                    和值</h1>
                                <input type='radio' name='playType' id='playType6306' value='6306' onclick='clickPlayType(this.value)' class="dd"/><span>直选</span>
                                <input type='radio' name='playType' id='playType6307' value='6307' onclick='clickPlayType(this.value)' class="dd"/><span>组选</span>
                            </div>
        ...
        <div class="right">
            ...
            <div class="rmain1">
                <div class="title">
                    <h1>
                        排列三新闻</h1>
                    <a href="../SiteNews/NewList.aspx?TypeId=101023">更多</a></div>
                <div class="neirong">
                    <ul>
