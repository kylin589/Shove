<%@ page language="C#" autoeventwireup="true" inherits="Help_zhifu, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpLeft">
            ...
            <div class="helpCon-left">
                <ul>
                    ...
                    <li><a style="color: #f00; font-weight: bold;" href="zhifu.aspx">网上支付</a></li>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    用户登录后进入账户中心。<br />
                    在“账户中心”页面左侧选择“账户充值”即可在右侧选择相应的网银支付</div>
            </div>
        </div>
    </div>
