<%@ page language="C#" autoeventwireup="true" inherits="Help_17185, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    充值后一般都是即时到账，如遇网络繁忙，可能会有几分钟的延时，请耐心等候；如果长时间仍未到账，请联系客服，提供充值的用户名、时间、金额、方式、订单号等信息，客服一定会在第一时间为您核实处理。
                </div>
            </div>
        </div>
    </div>
