<%@ page language="C#" autoeventwireup="true" inherits="Help_17189, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    登录后点击页面最上方“我的账户”，进入个人账户后再点击“我要提款”，根据提示填写相关的信息确认即可，提款成功后我们会在一个工作日内将相应的款项转入您的绑定账户中。
                </div>
            </div>
        </div>
    </div>
