<%@ page language="C#" autoeventwireup="true" inherits="Help_17198, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    数字彩提成为0%—10%，由发起人自行设定，%前的数字为整数即可。 足彩提成为5%—10%，由发起人自行设定，%前的数字为整数即可。
                </div>
            </div>
        </div>
    </div>
