<%@ page language="C#" autoeventwireup="true" inherits="Help_faq4, App_Web_85hasknr" enableEventValidation="false" %>
    ...
    <div class="helpContent">
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    <h1>
                        我喜欢一注/多注号码，希望每期都投注，能不能一次付钱，帮我每期都买呢？
                    </h1>
                    可以。请使用追号功能。比如您选了1注号，并决定连续5期都买这一注，那么您只要提前支付10元钱预付款，系统就会帮您每期都购买。（追号是指：追号指将一注或一组号码进行两期或两期以上的投注。追号可分为连续追号和间隔追号，连续追号指追号的期数是连续的，间隔追号指追号的期数不连续。比如您选了1组投注号码，并决定连续5期都买这一组，那么您只要提前支付10元钱预付款，系统就会帮您每期都购买。
                    ）
                </div>
            </div>
        </div>
