<%@ page language="C#" autoeventwireup="true" inherits="Help_faq13, App_Web_85hasknr" enableEventValidation="false" %>
    ...
    <div class="helpContent">
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    <h1>
                        合买大奖一般几天能分到钱啊，没实名认证的，提现也没问题吧？
                    </h1>
                    单注购买的彩票，奖金超过一万元需要到彩票中心领取，合买大奖一般7个工作日可以到你的账户。中奖奖金可以提现。
                </div>
            </div>
        </div>
    </div>
