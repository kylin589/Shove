<%@ page language="C#" autoeventwireup="true" inherits="Help_17203, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    进入方案详情后，有一项是“方案内容”，在方案内容中可以查看购买的号码，若是复式方案，在页面可以直接查看购买号码，若是单式方案需要下载后才可以查看。若发起人在发起方案时设置了方案“截止后公开”或“截止前仅对跟单者公开”，就要等国家销售截止后或跟单后才可以查看。
                </div>
            </div>
        </div>
    </div>
