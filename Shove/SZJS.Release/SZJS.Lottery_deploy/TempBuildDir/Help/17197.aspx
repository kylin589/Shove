<%@ page language="C#" autoeventwireup="true" inherits="Help_17197, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    登录后点击页面右上角“我的彩票”，进入个人账户后再点击“提取现金”，根据提示填写相关的信息确认即可，操作后我们会在一个工作日内将相应的款项转入您的绑定账户中。
                </div>
            </div>
        </div>
    </div>
