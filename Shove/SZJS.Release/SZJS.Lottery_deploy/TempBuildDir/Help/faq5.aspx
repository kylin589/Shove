<%@ page language="C#" autoeventwireup="true" inherits="Help_faq5, App_Web_85hasknr" enableEventValidation="false" %>
    ...
    <div class="helpContent">
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    <h1>
                        我想做的投注方案金额较大，可是手里投注资金有限，怎么办？能不能找人一起买？
                    </h1>
                    您可以发起合买，等待其他用户参与。（发起合买是指：合买是指由多人共同出资购买彩票，包括1个方案发起人和众多的合买参与人。这样可以在减少风险的前提下增加购买彩票的金额，增加中奖的机率。
                    ）<br />
                    由您发起合买方案，认购其中部分金额，其他的合买参与人购买方案中的剩余金额，多人共同出资购买彩票。这样可以在减少风险的前提下增加购买彩票的金额，增加中奖的机率。
                </div>
            </div>
        </div>
    </div>
