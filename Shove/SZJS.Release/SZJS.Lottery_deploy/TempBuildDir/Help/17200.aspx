<%@ page language="C#" autoeventwireup="true" inherits="Help_17200, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    发起人在发起合买时，可以设置一个保底金额（最少为方案总金额的20%），若直到销售截止，方案还未满员，发起人将以此金额的最大限度认购剩余部分，促成方案满员。
                </div>
            </div>
        </div>
    </div>
