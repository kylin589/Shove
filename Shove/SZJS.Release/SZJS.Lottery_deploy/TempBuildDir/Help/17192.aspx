<%@ page language="C#" autoeventwireup="true" inherits="Help_17192, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpRight">
            ...
            <div class="index_content">
                <div class="f12">
                    ...
                    数字彩、高频彩：每个彩种开奖时间不一样，具体请参考各彩种购买页面上方的提示。<br />
                    足彩（胜负彩、任选九场、四场进球、六场半全）：最后一场比赛结束后的当天上午11点左右。<br />
                    足球单场、竞彩足球、竞彩篮球：以您购买的场次中最后一场比赛的时间为准，在凌晨12点之前开始的比赛，一般在最后一场比赛结束后1小时内，凌晨12点之后开始的比赛，一般在第二天上午10点左右。<br />
                </div>
            </div>
        </div>
    </div>
