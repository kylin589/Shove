<%@ page language="C#" autoeventwireup="true" inherits="Help_bd, App_Web_85hasknr" enableEventValidation="false" %>
        ...
        <div class="helpLeft">
            ...
            <div class="helpCon-left">
                <ul>
                    ...
                    <li><a style="color: #f00; font-weight: bold;" href="bd.aspx">方案保底</a></li>
            ...
            <div class="index_content">
                <div class="f12">
                    <p style="font-size: 12px;">
                        <span style="color: #f00; font-weight: bold;">方案保底 </span>
                        <br />
                        发起人承诺合买截止后，如果方案还没有满员，发起人再投入先前承诺的金额以最大限度让方案成交。最低保底金额为方案总金额的20%。保底时，系统将暂时冻结保底资金，在合买截止时如果方案还未满员的话，系统将会用冻结的保底资金去认购方案。如果在合买截止前方案已经满员，系统会解冻保底资金。
                    </p>
                </div>
            </div>
        </div>
