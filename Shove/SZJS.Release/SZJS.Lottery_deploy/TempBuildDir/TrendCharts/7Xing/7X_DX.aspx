<%@ page language="C#" autoeventwireup="true" inherits="_7Xing_7X_DX, App_Web_1lgzyc3s" enableEventValidation="false" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码">
                                    <ItemStyle Width="50" Font-Bold="true" ForeColor="#dd0000" />
                                </asp:BoundField>
