<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_HZZST, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<!--
        function ShowImg(e) {
            if (e.innerHTML == "&nbsp;") {
                e.innerHTML = "<img src='../../Images/chartBall01.gif' />";
            }
            else {
                e.innerHTML = "&nbsp;";
            }
...
<li>
 <asp:Label ID="lbAd" runat="server"></asp:Label> <asp:Label ID="lbAd1" runat="server"></asp:Label> <asp:Label ID="lbAd2" runat="server"></asp:Label>
    ...
    <div class="wrap">
 <p><a href="<%= _Site.Url %>" target="_blank"><a href='FC3D_ZHXT.aspx' target='mainFrame'>
