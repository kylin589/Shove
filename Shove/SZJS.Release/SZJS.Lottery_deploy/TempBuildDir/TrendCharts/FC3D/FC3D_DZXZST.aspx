<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_DZXZST, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowImg(e) {
            if (e.innerHTML == "&nbsp;") {
                e.innerHTML = "<img src='../../Images/chartBall03.gif' />";
            }
            else {
                e.innerHTML = "&nbsp;";
            }
        ...
        $(function() {
        $("#GridView1 tr:odd").css("background-color", "#f8f2f2");
            $("#GridView1 tr:first").css("background-color", "#ffebeb").css("color", "#393838").css("font-weight", "bold");
            $("#GridView1 tr:last").css("background-color", "#ffebeb").css("color", "#393838").css("font-weight", "bold")
        });
    </script>
...
<div class="wrap">
<asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" OnRowCreated="GridView1_RowCreated"  ShowFooter="True">
                <Columns>
                    <asp:BoundField DataField="Isuse" HeaderText="期号">
                        <ItemStyle CssClass="b" />
                    </asp:BoundField>
