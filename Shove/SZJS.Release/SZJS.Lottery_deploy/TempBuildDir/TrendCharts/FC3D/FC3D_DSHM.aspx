<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_DSHM, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<body>
    ...
    <uc2:Head ID="Head2" runat="server" />
      <div class="wrap">
<div class="zst_top">
<dl><dt>3D游戏单双点号码分区表走势图</dt> </dl>
</div> 
</div> 
       <div class="wrap">
<table cellspacing="0" cellpadding="0"  bgcolor="#000000" border="0"  width="100%">
                        <tbody>
    ...
    <div class="wrap">
 <p>; 在220注不同组合的号码中，单点和双点各占一半，并且10注直选的“豹子”中有5注单点和5注双点，90注“组选3” 中有45注双点号码，120注"组选6"号码也同样是单双点各占60注。单点的号码中包括全奇和两偶一奇两种形式，双点号码含有全偶和两奇一偶。<br>
