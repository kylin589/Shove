<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_ZS, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<body>
    ...
    <div class="wrap">
<div class="zst_top">
<dl><dt>福彩3D&nbsp;&nbsp;3D质数分区号码组合表走势图</dt> <dd></dd></dl>
</div>  
</div>
<div class="wrap">
<table cellspacing="1" cellpadding="1" bgcolor="#000000" border="0" align="center"
        ...
        <div class="wrap">
<p> 只能被1和自身而不能被其他自然数整除的数字，称为“质数”。在0-9十个数字当中，有2，3，5，7四个质数。3d游戏有10注直选的“豹子”，90注“组选3”和120注“组选6”号码，其包含质数与不含质数的占有注数为：直选为4：6；“组选3”为60：30；“组选6”为100：20。由于含有质数的号码在总体中占有绝大部分，所以在中奖号码中，含质数号码中出的频率很高。<br>
                                        根据对不含质数中奖号码中出状况的跟踪与分布，当判断包含质数的号码中出希望较大时，即可在164注含质数号码中进行选择。<br />
