<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_KDZH, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <div class="wrap">
<div class="zst_top">
<dl><dt>3D游戏首尾边距组合分区表走势图</dt> <dd></dd></dl>
</div>
</div>  
<div class="wrap">
<table cellspacing="1" cellpadding="1" align="center" bgcolor="#000000" border="0">
   ...
   <div class="wrap">
 <p>中奖号码的最大号与最小号的差值，被称为“首尾边距”，有0-9共有十个不同的数值。边距为0的是10注直选“豹子”。1则为18注“组选3”号码，2-9都由不同的“组选3”和“组选6”组成。
