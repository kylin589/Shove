<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_HSZ, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<div class="wrap">
<div class="zst_top">
<dl><dt>3D和数值号码分区表走势图</dt> <dd></dd></dl>
</div>  
</div>
<div class="wrap">
...
根据对各个和数点位，以及单双点、大小点、除三余数的出号跟踪，当判断某一点位中出希望较大时，即可在相应和数点位中进行选号了。<br/> </span>
