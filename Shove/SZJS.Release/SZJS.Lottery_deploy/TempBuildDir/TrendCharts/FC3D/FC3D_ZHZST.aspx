<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_ZHZST, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<div class="wrap">        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
        ...
        <asp:Label ID="lbline" runat="server"></asp:Label></div>
        <div class="wrap">
<p>
