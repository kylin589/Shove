<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_DX_JO, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<uc2:head id="Head2" runat="server" />
 ...
 <div class="wrap">
<div class="zst_top">
<dl><dt>3D游戏大小分区 — 奇偶分区表走势图</dt> <dd></dd></dl>
</div>  
</div>
 <div class="wrap" >
 <table cellspacing="1" cellpadding="1" bgcolor="#000000" width="100%" align="center">
                                        <tbody>
...
<div class="wrap">
 <p>
<span class="bai">根据数学分类：1、3、5、7、9、为奇数，0、2、4、6、8为偶数，0、1、2、3、4是小数，5、6、7、8、9是大数，那么由0—9十个数字组成的三位数号码就可分为全奇、全偶、两奇一偶、两偶一奇、全大、全小、两大一小、两小一大共八种不同的基本形式。以任何一种形式为条件，又可分为四种不同的大小形式，反之亦然。<br>
                                            <br>
