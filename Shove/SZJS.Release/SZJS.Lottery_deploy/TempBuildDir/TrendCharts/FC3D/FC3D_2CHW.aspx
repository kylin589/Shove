<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_2CHW, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<head runat="server">
    ...
    table tr td{ text-align:center; border:solid 1px #CCC}
    </style>
</head>
<body>
...
<div class="wrap">
<div class="zst_top">
<dl><dt>福彩3D&nbsp;&nbsp;二次和尾差尾查询表走势图</dt>
</dl>
</div>
</div>
        
<div class="wrap"> <table >
                                    <tr bgcolor="#cccccc" style="border:solid 1px #CCC">
                                  
                                        <th style="background: url(http://www.zhcw.com/images/hwj.gif) no-repeat 0 0; width: 95px;
