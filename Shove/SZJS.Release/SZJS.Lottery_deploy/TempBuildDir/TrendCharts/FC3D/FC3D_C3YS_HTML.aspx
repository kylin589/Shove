<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_C3YS_HTML, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<table style="width:100%"   class="tab">
  <tbody>
                                    <tr>
                                        <td width="25" height="22" rowspan="2" bgcolor="#fcd5d5">
                                            &nbsp;
                                        </td>
                                        <td height="22" colspan="5" bgcolor="#fcd5d5">
                                            <div align="center">
                                                除三余数 --A
                                            </div>
                                        </td>
                                        <td height="22" colspan="15" bgcolor="#fcd5d5">
                                            <div align="center">
                                                除三余数 --B
                                            </div>
                                        </td>
                                        <td width="116" height="22" colspan="4" bgcolor="#fcd5d5">
                                            <div align="center">
                                                除三余数 --C
                                            </div>
                                        </td>
                                    ...
                                    <tr bgcolor="#ffffff">
                                        <td width="25" height="22" bgcolor="#fcd5d5">
                                            <div align="center">
                                                单选
                                            </div>
                                        </td>
                                        <td height="22" colspan="3" bgcolor="#fcd5d5">
                                            <div align="center">
                                                组选 3
                                            </div>
                                        </td>
                                        ...
                                        <td height="22" colspan="7" bgcolor="#fcd5d5">
                                            <div align="center">
                                                组选 3
                                            </div>
                                        </td>
                                        <td height="22" colspan="8" bgcolor="#fcd5d5">
                                            <div align="center">
                                                组选 6
                                            </div>
                                        </td>
                                        <td height="22" colspan="4" bgcolor="#fcd5d5">
                                            <div align="center">
                                                组选 6
                                            </div>
                                        </td>
 ...
 <div class="wrap">
                            <p>
                                ...
                                根据对除三余数A，B，C型的出号跟踪及相连中出情况的分析，当判断某一形式中出希望较大时，即可在相应组合中进行选号了。<br />
