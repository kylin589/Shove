<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_FC3D_FC3D_LHZH, App_Web_1hqvi6z9" enableEventValidation="false" %>
...
<div class="wrap">
<div class="zst_top">
<dl><dt>3D游戏连号组合分区表走势图</dt> <dd></dd></dl>
</div>  
</div>
<div class="wrap">
...
<div class="wrap">
<p> 连号即中奖号码中有两个或三个相连的号码，比如256、345等等。三连号又俗称为“拖拉机”，如果将0-9十个号码由小到大首尾相连，就会出现十注三连的“拖拉机”号码：012、123、234、345、456、567、678、789、890、901。连号共有90注，其中包含有20注“组选3”和70注“组选6”号码，其单，双点的比率是相同的。而不含连号的130注号码的单，双点也是各占一半。<br>
