<%@ page language="C#" autoeventwireup="true" inherits="Home_TrendCharts_SSQ_SSQ_DX, App_Web_j8uyfmgt" enableEventValidation="false" %>
...
<asp:Label ID="lbAd" runat="server"></asp:Label> <asp:Label ID="lbAd1" runat="server"></asp:Label> <asp:Label ID="lbAd2" runat="server"></asp:Label>
    ...
    <div class="wrap">
<p><a href="<%= _Site.Url %>" target="_blank">
