<%@ page language="C#" autoeventwireup="true" inherits="PL5_PL5_ZH, App_Web_1tgfu4ah" enableEventValidation="false" %>
        ...
        <div class="zst_top">
            ...
            <ul>
                ...
                <li><%--<a href="<%= _Site.Url %>" target="_blank">
                    <%=_Site.Name %>首页</a> <a href="<%= ResolveUrl("~/Lottery/Buy_PL3.aspx") %>" target="_blank">
                        排列三投注/合买</a> <a href="<%= ResolveUrl("~/WinQuery/63-0-0.aspx") %>" target="_blank">排列三中奖查询</a>--%>
