<%@ page language="C#" autoeventwireup="true" inherits="CJDLT_CJDLT_HZHeng, App_Web_nbnyao4e" enableEventValidation="false" %>
...
<div class="wrap"  style="overflow:scroll; text-align:center;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
            UseAccessibleHeader="False" OnRowCreated="GridView1_RowCreated" FooterStyle-HorizontalAlign="Center"
            HeaderStyle-HorizontalAlign="Center" ShowFooter="True" 
            align="center" CellPadding="0" OnRowDataBound="GridView1_RowDataBound">
