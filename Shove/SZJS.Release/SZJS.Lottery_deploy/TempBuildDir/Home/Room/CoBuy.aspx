<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_CoBuy, App_Web_y4qeesyo" enableEventValidation="false" %>
...
<body>
    ...
    <div runat="server" id="divData" visible="false">
        <asp:DataGrid ID="g" runat="server" Width="100%" AllowSorting="True" bordercolorlight="#BCD2E9"
            ...
            <ItemStyle Height="30px" HorizontalAlign="Center" BackColor="#FFFFFF" >
            </ItemStyle>
            <Columns>
