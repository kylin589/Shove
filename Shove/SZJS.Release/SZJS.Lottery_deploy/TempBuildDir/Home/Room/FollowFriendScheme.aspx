<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_FollowFriendScheme, App_Web_y4qeesyo" enableEventValidation="false" %>
...
<body onkeydown="if(event.keyCode==13){__doPostBack('btnSearch','');}">
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%;" bgcolor="#F2F2F2" style="height: 35px">
            <tr>
                ...
                <td style="padding-left: 15px; width: 100px;">
                    <asp:TextBox ID="TxtName" runat="server" value="输入用户名" size="25" onfocus="if(this.value=='输入用户名')this.value='';"
    ...
    <div>
        <asp:DataGrid ID="g" runat="server" Width="100%" BorderStyle="None" AllowSorting="True"
            bordercolorlight="#BCD2E9" bgcolor="#E9F1F8" AllowPaging="True" PageSize="22"
            AutoGenerateColumns="False" CellPadding="0" BackColor="#E9F1F8" OnItemDataBound="g_ItemDataBound"
            CellSpacing="0" OnItemCommand="g_ItemCommand" GridLines="None">
            <HeaderStyle HorizontalAlign="Center" Height="30px" ForeColor="#0066BA" BackColor="#ffede3">
            </HeaderStyle>
