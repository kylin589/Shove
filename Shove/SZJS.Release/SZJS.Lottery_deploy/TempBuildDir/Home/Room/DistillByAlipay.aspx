<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_DistillByAlipay, App_Web_y4qeesyo" enableEventValidation="false" %>
    ...
    <asp:Panel ID="pnlUserEdit" runat="server" Visible="true" Style="text-align: center;">
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
            ...
            <tr id="trIdCardNumber" runat="server" visible="true" bgcolor="#C0DBF9">
                ...
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    <span class="blue12">填写成功后用户不能自行修改，如需修改，请点击&nbsp;</span><span class="red12">在线客服</span>&nbsp;<span
                        class="blue12">咨询处理流程，请确认。</span>
                </td>
            </tr>
            <tr bgcolor="#C0DBF9">
                <td height="10" align="right" bgcolor="#FFFFFF" class="black12">
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
            ...
            <tr bgcolor="#C0DBF9">
                ...
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    ...
                    &nbsp;&nbsp; <span class="blue12"><a href="SafeSet.aspx?FromUrl='Distill.aspx?Type=1'"
                        target="_parent">
