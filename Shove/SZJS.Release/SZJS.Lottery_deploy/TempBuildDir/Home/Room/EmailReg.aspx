<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_EmailReg, App_Web_y4qeesyo" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>
        <%=_Site.Name %>购彩激活邮箱-用户中心-<%=_Site.Name %>－买彩票，就上<%=_Site.Name %>
        ！</title>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tbody id="tbOk" runat="server">
                        <tr>
                            ...
                            <td width="91%" style="font-size: 16px; color: #cc0000; font-family: Tahoma; line-height: 20px;
                                font-weight: bold;">
                                邮箱激活成功！
                            </td>
                        </tr>
                    ...
                    <tbody id="tbFailure" runat="server">
                        <tr>
                            <td width="91%" style="font-size: 16px; color: #cc0000; font-family: Tahoma; line-height: 20px;
                                font-weight: bold;" colspan="2" style="height: 45px;">
                                邮箱激活失败！
                            </td>
                        </tr>
                    </tbody>
