...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_BuySYYDJ.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_BuySYYDJ.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_BuySYYDJ.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_BuySYYDJ.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetIsuseInfo_callback(response) {
    ...
    $Id("div_QH_Today").innerHTML = arrInfo[2];
    ...
    toOpenIsuseTime.innerText = arrcurrIsuse[2].replace("/", "-").replace("/", "-");
...
function newBuy() {
    ...
    clickPlayType("playType6201");
    $Id("playType62001").checked = true;
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '6202':
            playTypeName = '任选二';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">6</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX2.htm';
            break;
        ...
        case '62022':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">6</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX2_DT.htm';
            break;
            
        case '6203':
            playTypeName = '任选三';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">19</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX3.htm';
            break;
        ...
        case '62033':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">19</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX3_DT.htm';
            break;
            
        case '6204':
            playTypeName = '任选四';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">78</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX4.htm';
            break;
        ...
        case '62044':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">78</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX4_DT.htm';
            break;
            
        case '6205':
            playTypeName = '任选五';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">540</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX5.htm';
            break;
        ...
        case '62055':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">540</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX5_DT.htm';
            break;

        case '6206':
            playTypeName = '任选六';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">90</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX6.htm';
            break;
        ...
        case '62066':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">90</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX6_DT.htm';
            break;
            
        case '6207':
            playTypeName = '任选七';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">26</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX7.htm';
            break;
        ...
        case '62077':
           ...
           $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">26</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX7_DT.htm';
            break;
            
        case '6208':
            playTypeName = '任选八';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>8</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">9</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX8.htm';
            break;

        case '6209':
            playTypeName = '前二直选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">130</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q2Zhi.htm';
            break;

        case '6210':
            playTypeName = '前三直选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">1170</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q3Zhi.htm';
            break;

        case '6211':
            playTypeName = '前二组选';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">65</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q2Zu.htm';
            break;
        ...
        case '62111':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">65</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q2Zu_DT.htm';
            break;
            
        case '6212':
            playTypeName = '前三组选';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">195</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q3Zu.htm';
            break;
        ...
        case '62122':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">195</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q3Zu_DT.htm';
            break;
            
        case '6213':
            document.getElementById('tbPlayTypeID').value = '6210';
            playTypeName = '前三复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">1170</i元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q3Fu.htm';
            break;
        ...
        case '6214':
            ...
            playTypeName = '前二复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">130</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_Q2Fu.htm';
            break;

        default:
            t = '6201';
            playTypeName = '任选1';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>1</font>个号码投注，选号与开奖号码<font color=red>第1位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">13</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/SYYDJ/SYYDJ_RX1.htm';
            break;
    }

     $Id('tdIntroduce').innerHTML += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><span style="color:red;cursor:pointer" id="spanExample"></i></strong>';

    document.getElementById("spanExample").title = Lottery_BuySYYDJ.GetExample(document.getElementById('tbPlayTypeID').value).value;
...
function ConvertDanToDT(number) {
    return Lottery_BuySYYDJ.ConvertDanToDT(number, parseInt(document.getElementById("tbPlayTypeID").value)).value;
}

function splitScheme(lotteryNumber) {
    return Lottery_BuySYYDJ.SplitScheme(lotteryNumber, document.getElementById("tbPlayTypeID").value).value;
}
