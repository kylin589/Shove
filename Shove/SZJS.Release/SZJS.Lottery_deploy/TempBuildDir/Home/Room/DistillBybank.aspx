<%@ page language="C#" autoeventwireup="true" inherits="Hoom_Room_DistillBybank, App_Web_y4qeesyo" enableEventValidation="false" %>
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
            ...
            <tr bgcolor="#C0DBF9">
                ...
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    ...
                    &nbsp;&nbsp; <span class="blue12"><a href="SafeSet.aspx?FromUrl='Distill.aspx?Type=2'"
                        target="_parent">
