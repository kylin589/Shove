<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_UserQQBind, App_Web_y4qeesyo" enableEventValidation="false" %>
...
<head runat="server">
    <title>绑定QQ号码-<%=_Site.Name %>-买彩票，就上<%=_Site.Name %></title>
