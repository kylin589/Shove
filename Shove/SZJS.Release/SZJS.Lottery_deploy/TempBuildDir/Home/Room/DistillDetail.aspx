<%@ page language="C#" autoeventwireup="true" inherits="Home_Room_DistillDetail, App_Web_y4qeesyo" enableEventValidation="false" %>
...
<body onload="Show();">
    ...
    <asp:DataGrid ID="gUserDistills" runat="server" Width="100%" BorderStyle="None" AllowPaging="True"
        PageSize="8" AutoGenerateColumns="False" CellPadding="0" BackColor="#DDDDDD"
        Font-Names="Tahoma" OnItemDataBound="gUserDistills_ItemDataBound" CellSpacing="1"
        GridLines="None" OnItemCommand="gUserDistills_ItemCommand" BorderColor="#E0E0E0"
        BorderWidth="2px">
        ...
        <ItemStyle BorderStyle="None" Height="30px" HorizontalAlign="Center" CssClass="black12" />
        <Columns>
            ...
            <asp:BoundColumn DataField="Money" HeaderText="支出(元)" ReadOnly="True">
                <ItemStyle Width="10%" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="FormalitiesFees" HeaderText="(手续费)" ReadOnly="True">
                <ItemStyle Width="10%" />
            </asp:BoundColumn>
            <asp:BoundColumn HeaderText="交易类型" ReadOnly="True">
                <ItemStyle Width="10%" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="Result" HeaderText="状态" ReadOnly="True">
                <ItemStyle Width="10%" />
            </asp:BoundColumn>
            ...
            <asp:BoundColumn DataField="Memo" HeaderText="备注" ReadOnly="True">
                <ItemStyle Width="25%" />
            </asp:BoundColumn>
            <asp:BoundColumn DataField="DateTime" HeaderText="交易时间" ReadOnly="True">
                <ItemStyle Width="15%" />
            </asp:BoundColumn>
        </Columns>
