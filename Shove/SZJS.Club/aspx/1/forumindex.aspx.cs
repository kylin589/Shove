    ...
    public partial class forumindex : PageBase
    {
        ...
        override protected void OnLoad(EventArgs e)
        {
            ...
            */
            ...
            templateBuilder.Append("    <td width=\"33%\" height:65px background=\"/templates/default/images/header_bg.gif\" class=\"textstyle\"><font style=\"color:#DD0000\">最新发表主题</font></td>\r\n");
            templateBuilder.Append("    <td width=\"33%\" height:65px background=\"/templates/default/images/header_bg.gif\" class=\"textstyle\"><font style=\"color:#DD0000\">最新回复主题</font></td>\r\n");
            templateBuilder.Append("    <td width=\"33%\" height:65px background=\"/templates/default/images/header_bg.gif\" class=\"textstyle\"><font style=\"color:#DD0000\">社区今日热贴</font></td>\r\n");
            templateBuilder.Append("  </tr>\r\n");
            ...
            templateBuilder.Append("        <ul>\r\n");
            templateBuilder.Append("      <script type=\"text/javascript\" src=\"tools/showtopics.aspx?template=7&order=0&count=10&length=19&encoding=utf-8&timespan=0\"></" + "script>\r\n");
            templateBuilder.Append("    </ul>\r\n");
            templateBuilder.Append("</td>\r\n");
            templateBuilder.Append("<!--最新回复主题-->\r\n");
            templateBuilder.Append("    <td style=\"vertical-align:top;\">\r\n");
            templateBuilder.Append("  <ul>\r\n");
            templateBuilder.Append("      <script type=\"text/javascript\" src=\"tools/showtopics.aspx?template=7&order=2&count=10&length=19&encoding=utf-8&timespan=0\"></" + "script>\r\n");
            templateBuilder.Append("  </ul>\r\n");
            templateBuilder.Append("</td>\r\n");
            templateBuilder.Append("<!--是否精华-->\r\n");
            templateBuilder.Append("<td style=\"vertical-align:top;\">\r\n");
            templateBuilder.Append("  <ul>\r\n");
            templateBuilder.Append("      <script type=\"text/javascript\" src=\"tools/showtopics.aspx?template=7&order=1&time=1&count=10&length=19&encoding=utf-8&timespan=0\"></" + "script>\r\n");
            templateBuilder.Append("  </ul>\r\n");
            templateBuilder.Append("</td>\r\n");
