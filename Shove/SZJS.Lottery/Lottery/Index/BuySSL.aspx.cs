...
public partial class Lottery_Index_BuySSL : SitePageBase
{
    public int LotteryID;
    protected void Page_Load(object sender, EventArgs e)
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(Lottery_Index_BuySSL), this.Page);
        LotteryID = 29;
        if (!IsPostBack)
        {
            if (_User != null)
    ...
    public string GenerateLuckLotteryNumber(int LotteryID)
    {
        ...
        LotteryNumber = new SZJS.Lottery()[LotteryID].BuildNumber(1);
    ...
    private void Buy(Users _User)
    {
        ...
        string LotteryNumber = this.tb_LotteryNumber.Value.Replace(" ", "") + "\r";
