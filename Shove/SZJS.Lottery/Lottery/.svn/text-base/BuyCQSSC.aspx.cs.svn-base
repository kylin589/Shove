...
public partial class Lottery_BuyCQSSC : SitePageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AjaxPro.Utility.RegisterTypeForAjax(typeof(Lottery_BuyCQSSC), this.Page);
        LotteryID = 28;
        if (!IsPostBack)
        {
            RepNewt.DataSource = GetNews("时时彩咨询");
            RepNewt.DataBind();
