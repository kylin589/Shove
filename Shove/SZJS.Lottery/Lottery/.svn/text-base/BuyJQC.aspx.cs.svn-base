...
public partial class Lottery_BuyJQC : SitePageBase
{
    ...
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(Lottery_BuyJQC), this.Page);
        LotteryID = 2;
        if (!IsPostBack)
        {
    ...
    public string GetAddone(int LotteryID, string IsuseID)
    {
        ...
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable("DataCache_JQC");
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            Shove._Web.Cache.SetCache("DataCache_JQC", dt, 300);
        }
