...
public class DataCache
{
    ...
    public static DataTable GetIsusesInfo(int LotteryID)
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            if (dt != null)
            {
                Shove._Web.Cache.SetCache(IsusesInfo + LotteryID.ToString(), dt, (LotteryID == 62 || LotteryID == 29 || LotteryID == 70 || LotteryID == 61 || LotteryID == 28) ? 0 : 600);
            }
        }
    ...
    public static DataTable GetWinInfo(int LotteryID)
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                Shove._Web.Cache.SetCache(WinInfo + LotteryID.ToString(), dt, (LotteryID == 62 || LotteryID == 29 || LotteryID == 70 || LotteryID == 61 || LotteryID == 28) ? 300 : 600);
            }
        }
    ...
    public static DataTable GetWinNumber(int LotteryID)
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            dt = new DAL.Tables.T_Isuses().Open("top 15 Name, WinLotteryNumber, EndTime", "LotteryID=" + LotteryID + " and IsOpened = 1 and IsNull(WinLotteryNumber,'')<>''", "EndTime Desc");
            ...
            if (dt != null)
            {
                ...
                Shove._Web.Cache.SetCache(WinNumber + LotteryID.ToString(), dt, (LotteryID == 62 || LotteryID == 29 || LotteryID == 70 || LotteryID == 61 || LotteryID == 28) ? 120 : 600);
            }
        }
    ...
    public static string GetLotteryNews(int LotteryID)
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                Shove._Web.Cache.SetCache(LotteryNews + LotteryID.ToString(), dt, 600);
            }
        }
