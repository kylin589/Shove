...
public class BLL
{
    ...
    {
        DataTable dt1 = Shove._Web.Cache.GetCacheAsDataTable("1ds11");
        ...
        if (dt1 == null)
        {
            ...
            Shove._Web.Cache.SetCache("1ds11", ds.Tables[0]);
        }
    ...
    {
        DataTable dt1 = Shove._Web.Cache.GetCacheAsDataTable("AAds11");
        ...
        if (dt1 == null)
        {
            ...
            Shove._Web.Cache.SetCache("AAds11", ds.Tables[0]);
        }
    ...
    {
        DataTable dt1 = Shove._Web.Cache.GetCacheAsDataTable("ds11");
        ...
        if (dt1 == null)
        {
            ...
            Shove._Web.Cache.SetCache("ds11", ds.Tables[0]);
        }
    ...
    {
        DataTable dt1 = Shove._Web.Cache.GetCacheAsDataTable("33ds11");
        ...
        if (dt1 == null)
        {
            ...
            Shove._Web.Cache.SetCache("33ds11", ds.Tables[0]);
        }
    ...
    {
        DataTable dt1 = Shove._Web.Cache.GetCacheAsDataTable(" CJDLT_TeMa_SeleteByNum_ds11");
        ...
        if (dt1 == null)
        {
            ...
            Shove._Web.Cache.SetCache(" CJDLT_TeMa_SeleteByNum_ds11", ds.Tables[0]);
        }
