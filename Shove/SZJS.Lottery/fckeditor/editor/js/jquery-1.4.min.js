...
jQuery.fn.chose=function(o,name)
{	
	var mainObjCheck = (typeof o=='object'?$(o):this).attr("checked")?true:false;
	this.each(function(){
		$(this).attr('checked',mainObjCheck);
	});
	$("input:checkbox[name='"+(typeof o=='object'?name:o)+"']").each(function(){
		$(this).attr("checked",mainObjCheck);
	});
}