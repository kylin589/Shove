...
public partial class tuan_Alipay_Send2 : SitePageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            return_url = Shove._Web.Utility.GetUrl() + "/tuan/Alipay/Receive.aspx?" + HttpUtility.UrlEncode("BuyID=" + Shove._Web.Utility.GetRequest("BuyID")); //服务器通知返回接口
            notify_url = Shove._Web.Utility.GetUrl() + "/tuan/Alipay/AlipayNotify.aspx";  //服务器通知返回接口(暂时不用
