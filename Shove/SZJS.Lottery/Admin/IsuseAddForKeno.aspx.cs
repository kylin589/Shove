...
public partial class Admin_IsuseAddForKeno : AdminPageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            object oLastDate = MSSQL.ExecuteScalar("SELECT ISNULL(MAX(EndTime), DATEADD([day], - 1, GETDATE())) AS LastDate from T_Isuses where LotteryID = " + LotteryID.ToString());
