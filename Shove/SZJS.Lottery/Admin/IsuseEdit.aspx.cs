...
public partial class Admin_IsuseEdit : AdminPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            if (LotteryID == SZJS.Lottery.SFC.ID || LotteryID == SZJS.Lottery.ZCSFC.ID || LotteryID == SZJS.Lottery.ZCRJC.ID)
            {
                pSFC.Visible = true;
            }

            if (LotteryID == SZJS.Lottery.JQC.ID)
            {
                pJQC.Visible = true;
            }

            if (LotteryID == SZJS.Lottery.LCBQC.ID)
            {
                pLCBQC.Visible = true;
            }

            if (LotteryID == SZJS.Lottery.LCDC.ID)
            {
                pLCDC.Visible = true;
            }

            if (LotteryID == SZJS.Lottery.ZCDC.ID)
            {
                ZCDC.Visible = true;
            }
    ...
    private void BindData()
    {
        ...
        if (tbLotteryID.Text == SZJS.Lottery.SFC.sID || tbLotteryID.Text == SZJS.Lottery.ZCSFC.sID || tbLotteryID.Text == SZJS.Lottery.ZCRJC.sID)
        {
        ...
        if (tbLotteryID.Text == SZJS.Lottery.JQC.sID)
        {
        ...
        if (tbLotteryID.Text == SZJS.Lottery.LCBQC.sID)
        {
        ...
        if (tbLotteryID.Text == SZJS.Lottery.LCDC.sID)
        {
        ...
        if (tbLotteryID.Text == SZJS.Lottery.ZCDC.sID)
        {
            dt = new DAL.Tables.T_IsuseForZCDC().Open("", "IsuseID = " + Shove._Web.Utility.FilteSqlInfusion(tbIsuseID.Text), "[No]");
