...
public partial class Admin_ImageNews : AdminPageBase
{
    ...
    protected void g_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        {
            this.Response.Redirect("ImageNewsEdit.aspx?ID=" + e.Item.Cells[4].Text, true);
        ...
        {
            new DAL.Tables.T_FocusImageNews().Delete("ID="+e.Item.Cells[4].Text.Trim());
    ...
    protected void g_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        {
            CheckBox cb = (CheckBox)e.Item.FindControl("cbIsBig");
