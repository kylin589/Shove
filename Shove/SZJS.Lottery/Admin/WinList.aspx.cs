...
public partial class Admin_WinList : AdminPageBase
{
    ...
    private void BindDataForIsuse()
    {
        ...
        DataTable dt = new DAL.Tables.T_Isuses().Open("[ID], [Name]", "LotteryID = " + Shove._Web.Utility.FilteSqlInfusion(ddlLottery.SelectedValue) + " and EndTime < GetDate() and isOpened = 1", "EndTime desc");
