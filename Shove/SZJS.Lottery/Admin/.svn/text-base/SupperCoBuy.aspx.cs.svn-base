...
public partial class Admin_SupperCoBuy : AdminPageBase
{
    ...
    private bool IsCheck(string schemeID)
    {
        ...
        DataTable dt = new DAL.Tables.T_SchemeSupperCobuy().Open("", "TypeState=" + Shove._Web.Utility.GetRequest("TypeState") + "", "");
    ...
    protected void g_ItemCheckedChanged(object sender, System.EventArgs e)
    {
        ...
        {
            PF.GoError(ErrorNumber.DataReadWrite, "数据库繁忙，请重试", "Admin_SupperCoBuy");
