...
public partial class Admin_Competence : AdminPageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            // 总站外不能这是这几个权限
            if (_Site.Level != SiteLevels.MasterSite)
            {
                cbGroup3.Enabled = false;
                cbGroup8.Enabled = false;

                cbCompetence6.Enabled = false;
                cbCompetence7.Enabled = false;
                cbCompetence11.Enabled = false;
                cbCompetence12.Enabled = false;
                cbCompetence13.Enabled = false;
                cbCompetence17.Enabled = false;
            }
    ...
    private void SetCheckBoxEnabled(bool Value)
    {
        ...
        if (Value && (_Site.Level != SiteLevels.MasterSite))
        {
            cbGroup3.Enabled = false;
            cbGroup8.Enabled = false;
