...
public partial class Admin_ChaseList : AdminPageBase
{
    ...
    private void BindData()
    {
        ...
        if (dt == null)
        {
            ...
            sb.Append("select '我的追号' as Type,ID,Name,DateTime,LotteryName,Title,SumMoney,SumIsuseNum,BuyedIsuseNum,QuashedIsuseNum,QuashStatus,2 as StopType,StopWhenWinMoney  from V_ChaseTasksTotal ");
