...
public partial class Admin_IsuseAdd : AdminPageBase
{
    ...
    protected void btCompetitionNum_Click(object sender, EventArgs e)
    {
        ...
        newDC = new DataColumn("League", System.Type.GetType("System.String"));
        dt.Columns.Add(newDC);
        ...
        dt.Columns.Add(newDC);
        newDC = new DataColumn("loseBall", System.Type.GetType("System.String"));
        dt.Columns.Add(newDC);
        newDC = new DataColumn("Time", System.Type.GetType("System.String"));
        dt.Columns.Add(newDC);
        newDC = new DataColumn("color", System.Type.GetType("System.String"));
        dt.Columns.Add(newDC);
    ...
    protected DataTable CatchIsues()
    {
        ...
        Html = GetHtml("http://zc.trade.500wan.com/bjdc/index.php", true);//http://trade.500wan.com/pages/info/bjdc/zc.php?msgmode=2&expect=" + Isuse + "&jumphost=http://www.500wan.com
