...
public partial class Admin_Site : AdminPageBase
{
    ...
    private void BindData()
    {
        ...
        labLevel.Text = SiteLevels.GetSiteLevelName(_Site.Level);
        imgON.ImageUrl = (_Site.ON ? "style/images/Run.gif" : "style/images/Stop.gif");
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        _Site.Urls = Shove._Convert.ToDBC(URL).Trim();
