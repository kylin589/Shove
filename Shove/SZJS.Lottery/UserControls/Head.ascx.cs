...
public partial class UserControls_Head : UserControlBase
{
    ...
    {
        string PageName = HttpContext.Current.Request.Url.ToString().Replace(GetRootURI(), "0");
        if (name.ToLower().Equals(PageName.ToLower()))
            return "style=\"background:#fff;font-weight: bold;color: #d31755;\"";
        return " ";
    }
}
