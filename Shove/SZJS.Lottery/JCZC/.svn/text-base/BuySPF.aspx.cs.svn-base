...
public partial class JCZC_BuySPF : SitePageBase
{
            ...
            try
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    sb.Append("<tr class='" + lineStyle + "' zid=\"" + dr["MatchID"].ToString() + "\" mid=\"" + dr["MatchID"].ToString() + "\" pname=\"" + (((int)startDate.DayOfWeek) == 0 ? 7 : ((int)startDate.DayOfWeek)).ToString() + dr["MatchNumber"].ToString().Substring(dr["MatchNumber"].ToString().Length - 3) + "\" pdate=\"" + saleEndDate.ToString("yyyy-MM-dd") + "\"  lg=\"" + dr["Game"].ToString() + "\" rq=\"" + dr["mainloseball"].ToString() + "\" win=\"" + dr["Win"].ToString() + "\" draw=\"" + dr["Flat"].ToString() + "\" lost=\"" + dr["Lose"].ToString() + "\">")
                        ...
                        .AppendLine("亚")
                        .AppendLine("欧</td>")
                        .AppendLine("<td class=\"sp_bg\" align=\"center\" style=\"cursor:pointer\">&nbsp;<input type=\"checkbox\" value=\"3\" /><span>" + Shove._Convert.StrToDouble(dr["Win"].ToString(), 0).ToString("F2") + "</span><font style=\"font-weight:lighter; color:red;\"><br/>" + dr["SNumberCount"].ToString() + "</font></td>")
                        .AppendLine("<td class=\"sp_bg\" align=\"center\" style=\"cursor:pointer\">&nbsp;<input type=\"checkbox\" value=\"1\" /><span>" + Shove._Convert.StrToDouble(dr["Flat"].ToString(), 0).ToString("F2") + "</span><font style=\"font-weight:lighter; color:red;\"><br/>" + dr["PNumberCount"].ToString() + "</font></td>")
                        .AppendLine("<td class=\"sp_bg\" align=\"center\" style=\"cursor:pointer\">&nbsp;<input type=\"checkbox\" value=\"0\" /><span>" + Shove._Convert.StrToDouble(dr["Lose"].ToString(), 0).ToString("F2") + "</span><font style=\"font-weight:lighter; color:red;\"><br/>" + dr["FNumberCount"].ToString() + "</font></td>")
