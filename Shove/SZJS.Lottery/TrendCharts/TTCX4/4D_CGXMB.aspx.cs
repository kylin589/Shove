...
public partial class Home_TrendCharts_4D_4D_CGXMB : TrendChartPageBase
{
    ...
    private void BindDataForAD()
    {
        ...
        DataRow[] drAd = dt.Select("LotteryID=60 and [Name] = '广告一'", "[Order]");
        DataRow[] drAd1 = dt.Select("LotteryID=60 and [Name] = '广告二'", "[Order]");
        DataRow[] drAd2 = dt.Select("LotteryID=60 and [Name] = '广告三'", "[Order]");
    ...
    protected void GridViewBind()
    {
        ...
        dt = new TrendChart().D4_CGXMB_Select(30, "", "", ref result); //，默认显示30期
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = new TrendChart().D4_CGXMB_Select(50, "", "", ref result); //，默认显示50期
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = new TrendChart().D4_CGXMB_Select(100, "", "", ref result); //，默认显示100期
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dt = new TrendChart().D4_CGXMB_Select(0, tb1.Text.ToString(), tb2.Text.ToString(), ref result);
    ...
    protected void ColorBind()
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            for (int j = 5; j < 15; j++)
            {
                ...
                {
                    Label lb = new Label();
                    lb.Text = "<strong style='color:Red' id='" + "GridView1_ctl" + (i + 2).ToString().PadLeft(2, '0') + "_" + i.ToString() + "_" + j.ToString() + "' />" + (j - 5).ToString();
            ...
            for (int j = 15; j < 25; j++)
            {
                ...
                {
                    Label lb = new Label();
                    lb.Text = "<strong style='color:blue' id='" + "GridView1_ctl" + (i + 2).ToString().PadLeft(2, '0') + "_" + i.ToString() + "_" + j.ToString() + "' />" + (j - 15).ToString();
    ...
    protected void DrawGridHeader(HtmlTextWriter output, Control ctl)
    {
        ...
        output.Write("<td rowspan='2'  bgcolor='#e8f1f8' >和数值</td>");
        output.Write("<td rowspan='2'  bgcolor='#e8f1f8' >奇偶比</td>");
        output.Write("<td rowspan='2'  bgcolor='#e8f1f8' >大小比</td>");
        output.Write("<td colspan='10'  bgcolor='#e8f1f8' height='28'>跨度走势</td>");
        output.Write("<td colspan='10'  bgcolor='#e8f1f8' >和值走势</td>");
    ...
    protected void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        ...
        output.Write("<td rowspan='3'   height='28'>期号</td>");
        output.Write("<td rowspan='2'  >开奖号码</td>");
        output.Write("<td rowspan='2'  >和数值</td>");
        output.Write("<td rowspan='2'   >奇偶比</td>");
        output.Write("<td rowspan='2'  >大小比</td>");
        for (int i = 0; i < 10; i++)
        {
            output.Write("<td  height='28px' >");
            output.Write(i.ToString() + "</td>");
        }
        for (int i = 0; i < 10; i++)
        {
        ...
        output.Write("<td colspan='10'  >跨度走势</td>");
        output.Write("<td colspan='10'   >和值走势</td>");
    }
