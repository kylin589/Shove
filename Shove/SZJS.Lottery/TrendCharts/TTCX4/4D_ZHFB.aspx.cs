...
public partial class Home_TrendCharts_4D_4D_ZHFB : TrendChartPageBase
{
    ...
    protected void GridViewBind()
    {
        ...
        dt = new TrendChart().D4_ZHFB_Select(30, "", "", ref result); //，默认显示30期
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = new TrendChart().D4_ZHFB_Select(50, "", "", ref result); //，默认显示50期
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dt = new TrendChart().D4_ZHFB_Select(0, tb1.Text.ToString(), tb2.Text.ToString(), ref result);
    ...
    protected void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        ...
        output.Write("<td colspan='10'  height='28'>第四位</td>");
