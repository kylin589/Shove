...
public partial class Home_TrendCharts_FC3D_FC3D_DZXZST : TrendChartPageBase
{
    ...
    protected void DrawGridHeader(HtmlTextWriter output, Control ctl)
    {
        ...
        output.Write("<td style='width:28px'>大<br />大<br />大</td>");
         output.Write("<td style='width:28px'>大<br />大<br />中</td>");
         output.Write("<td style='width:28px'>大<br />大<br />小</td>");
        output.Write("<td style='width:28px'>大<br />中<br />大</td>");
        output.Write("<td style='width:28px'>大<br />中<br />中</td>");
        output.Write("<td style='width:28px'>大<br />中<br />小</td>");
        output.Write("<td style='width:28px'>大<br />小<br />大</td>");
        output.Write("<td style='width:28px'>大<br />小<br />中</td>");
        output.Write("<td style='width:28px'>大<br />小<br />小</td>");
        output.Write("<td style='width:28px'>中<br />大<br />大</td>");
        output.Write("<td style='width:28px'>中<br />大<br />中</td>");
        output.Write("<td style='width:28px'>中<br />大<br />小</td>");
        output.Write("<td style='width:28px'>中<br />中<br />大</td>");
        output.Write("<td style='width:28px'>中<br />中<br />中</td>");
        output.Write("<td style='width:28px'>中<br />中<br />小</td>");
        output.Write("<td style='width:28px'>中<br />小<br />大</td>");
        output.Write("<td style='width:28px'>中<br />小<br />中</td>");
        output.Write("<td style='width:28px'>中<br />小<br />小</td>");
        output.Write("<td style='width:28px'>小<br />大<br />大</td>");
        output.Write("<td style='width:28px'>小<br />大<br />中</td>");
        output.Write("<td style='width:28px'>小<br />大<br />小</td>");
        output.Write("<td style='width:28px'>小<br />中<br />大</td>");
        output.Write("<td style='width:28px'>小<br />中<br />中</td>");
        output.Write("<td style='width:28px'>小<br />中<br />小</td>");
        output.Write("<td style='width:28px'>小<br />小<br />大</td>");
        output.Write("<td style='width:28px'>小<br />小<br />中</td>");
        output.Write("<td style='width:28px'>小<br />小<br />小</td>");
       
    }

    protected void DrawGridFooter(HtmlTextWriter output, Control ctl)
    {
        output.Write("<td  height='25px'>预选1</td>");
        output.Write("<td >&nbsp;</td>");

        for (int i = 0; i < 27; i++)
        {
            output.Write("<td onClick=ShowImg(this) style='cursor:pointer;' >&nbsp;</td>");
        }

        output.Write("<tr  >");
        output.Write("<td  height='25px'>预选2</td>");
        output.Write("<td >&nbsp;</td>");
        ...
        output.Write("<tr  >");
        output.Write("<td  height='25px'>预选3</td>");
        output.Write("<td >&nbsp;</td>");
        ...
        output.Write("<tr style='background-color:#ffa3ab'>");
