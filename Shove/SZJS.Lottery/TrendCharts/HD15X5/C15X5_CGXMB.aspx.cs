...
public partial class Home_TrendCharts_C15X5_C15X5_CGXMB : TrendChartPageBase
{
    ...
    protected void GridViewBind()
    {
        ...
        dt = new TrendChart().C15X5_CGXMB_Select(30, "", "", ref result); //，默认显示30期
    ...
    protected void btnTop50_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = new TrendChart().C15X5_CGXMB_Select(50, "", "", ref result); //，默认显示50期
        if (dt == null || dt.Rows.Count < 1)
        {
            //Shove._Web.JavaScript.Alert(this.Page, "数据库里没有此彩种开奖号码信息！");
        }
    ...
    protected void btnTop100_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = new DataTable();
        dt = new TrendChart().C15X5_CGXMB_Select(100, "", "", ref result); //，默认显示100期
        if (dt == null || dt.Rows.Count < 1)
        {
            //Shove._Web.JavaScript.Alert(this.Page, "数据库里没有此彩种开奖号码信息！");
        }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        dt = new TrendChart().C15X5_CGXMB_Select(0, tb1.Text.ToString(), tb2.Text.ToString(), ref result);
        if (dt == null || dt.Rows.Count < 1)
        {
            //Shove._Web.JavaScript.Alert(this.Page, "数据库里没有此彩种开奖号码信息！");
        }
