...
<body style="margin: 0px; background-color: buttonface;">
    ...
    <div>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
            <tr>
                <td height="25" style="background-image: url(../Images/pic_bg_25.jpg)" bgcolor="#f7f7f7"
                    class="black12">
                    &nbsp;&nbsp;&nbsp;元素库 &gt; 图片库
                        ...
                        <tr>
                                ...
                                <table width="150" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                                    <tr>
                                        <td height="25" style="background-image: url(../Images/pic_bg_25.jpg)" bgcolor="#FFFFFF">
                                            <asp:TreeView ID="tvImgDir" Font-Bold="false" Font-Size="10pt" ForeColor="#003366"
                                                runat="server" OnSelectedNodeChanged="tvImgDir_SelectedNodeChanged">
                                            </asp:TreeView>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td width="649" valign="top">
                                ...
                                <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td align="left" style="padding-left: 10px;" class="black12">
                                            ...
                                            <asp:ImageButton runat="server" ID="ibSearch" ImageUrl="../Images/img_search.jpg"
                                                OnClick="ibSearch_Click" />&nbsp;
                                            <asp:Label runat="server" ID="lblMsg3" ForeColor="Red"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table runat="server" id="tableUpLoadImg" visible="false" width="630" border="0"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="padding-left: 10px;" class="black12">
                                            ...
                                            <asp:ImageButton runat="server" ID="ibUpLoad" ImageUrl="../Images/pic_botton_2.jpg"
                                                OnClick="ibUpLoad_Click" />&nbsp;
                                            <asp:Label runat="server" ID="lblMsg" ForeColor="Red"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                                <table width="630" runat="server" id="tableUpLoadElement" visible="false" border="0"
                                    align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td align="left">
                                            ...
                                            <div id="odiv" style="display: none; text-align: center; width: 630;">
                                                <table width="100%" style="background-color: #CCCCCC;" border="0" align="center"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="padding-left: 10px; background-color: #FFFFFF;">
                                                            <asp:DropDownList runat="server" ID="ddlImgTypes" AutoPostBack="true" Height="28"
                                                                CssClass="in_p" OnSelectedIndexChanged="ddlImgTypes_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" style="padding-left: 10px; background-color: #FFFFFF;" class="black12">
                                                            ...
                                                            <asp:ImageButton runat="server" ID="ibUpLoadElement" ImageUrl="../Images/pic_botton_2.jpg"
                                                                OnClick="ibUpLoadElement_Click" />&nbsp; &nbsp;
                                    ...
                                    <tr>
                                        <td bgcolor="#FFFFFF">
                                            ...
                                            <table width="610" border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:DataList runat="server" ID="ImageList" RepeatDirection="Horizontal" Width="100%"
                                                            RepeatColumns="3">
                                                            <ItemTemplate>
                                ...
                                <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td width="91">
                                            <asp:ImageButton runat="server" ID="imgSelectAll" ImageUrl="../Images/pic_botton_5.jpg"
                                                OnClick="imgSelectAll_Click" />
                                        </td>
                                        <td width="90">
                                            <asp:ImageButton runat="server" ID="imgDelete" ImageUrl="../Images/pic_botton_4.jpg"
                                                OnClick="imgDelete_Click" />
                                        </td>
                                        <td width="410">
                                            <asp:ImageButton runat="server" ID="Submit" ImageUrl="../Images/pic_botton_3.jpg"
                                ...
                                <table width="630" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="297" height="30" class="black12" align="center">
                                            <asp:LinkButton runat="server" CommandArgument="first" ID="lnkFirst" Text="首页" class="a"
                                                OnCommand="Page_Click"></asp:LinkButton>&nbsp;
                                            <asp:LinkButton runat="server" ID="lnkPrev" Text="上一页" CommandArgument="prev" class="a"
                                                OnCommand="Page_Click"></asp:LinkButton>&nbsp;
                                            <asp:LinkButton runat="server" ID="lnkNext" Text="下一页" CommandArgument="next" class="a"
                                                OnCommand="Page_Click"> </asp:LinkButton>&nbsp;
                                            <asp:LinkButton runat="server" ID="lnkLast" Text="尾页" CommandArgument="last" class="a"
                                                OnCommand="Page_Click"></asp:LinkButton>&nbsp; | 共 <span style="color: Red">
                                        ...
                                        <td width="187" class="black12">
                                            <asp:ImageButton runat="server" ID="pageSubmit" ImageUrl="../Images/pic_botton_1.jpg"
                                                OnClick="pageSubmit_Click" />
                                        </td>
                                    </tr>
                                </table>
                                <table width="150" border="0" cellspacing="0" cellpadding="0">
