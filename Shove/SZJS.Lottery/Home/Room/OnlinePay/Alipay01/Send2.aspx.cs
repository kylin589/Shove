...
public partial class Home_Room_OnlinePay_Alipay01_Send2 : SitePageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            return_url = Shove._Web.Utility.GetUrl() + "/Home/Room/OnlinePay/Alipay01/Receive.aspx?" + HttpUtility.UrlEncode("BuyID=" + Shove._Web.Utility.GetRequest("BuyID")); //服务器通知返回接口
