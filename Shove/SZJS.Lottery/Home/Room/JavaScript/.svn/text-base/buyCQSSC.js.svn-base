...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_BuyCQSSC.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_BuyCQSSC.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_BuyCQSSC.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_BuyCQSSC.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetIsuseInfo_callback(response) {
    ...
    var vlastIsuseInfo = arrInfo[1];
    var chaseIsuse = arrInfo[2];
    var vLastWinNumber = arrInfo[3];
    $Id("lastIsuseInfo").innerText = vlastIsuseInfo;
    $Id("LastWinNumber").innerHTML = vLastWinNumber;
...
function HidBtnRand(playTypeName) {
    ...
    var isHidRandTR = playTypeName.indexOf("组合") > -1 || playTypeName.indexOf("复选") > -1 ||playTypeName.indexOf("复式")>-1|| playTypeName.indexOf("包点") > -1 || playTypeName.indexOf("包胆") > -1 || playTypeName.indexOf("小单") > -1 || playTypeName.indexOf("组三") > -1 || playTypeName.indexOf("组六") > -1;
    if (isHidRandTR) {
...
function accountAllMoney() {
    ...
    var objs = document.getElementsByName("Chasecheck");
...
function clickPlayType(t) {
    ...
    switch (t) {
        case 'playType2801':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_5XDS.htm';
            break;
        ...
        case 'playType2802':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_5XFS.htm';
            break;

        case 'playType2803':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">100000</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_5XZH.htm';
            break;

        case 'playType2804':
            playTypeName = '五星通选单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖<span style="color:red" id="spanPlayTypeMoney">20000</span> 元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_5XTXDS.htm';
            break;

        case 'playType2805':
            playTypeName = '五星通选复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖 <span style="color:red" id="spanPlayTypeMoney">20000</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_5XTXFS.htm';
            break;
        ...
        case 'playType2806':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_3XDS.htm';
            break;
        ...
        case 'playType2807':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_3XFS.htm';
            break;

        case 'playType2808':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">1000</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_3XZH.htm';
            break;
        ...
        case 'playType2809':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2_3.htm';
            break;
        ...
        case 'playType2810':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2_4.htm';
            break;
        ...
        case 'playType2811':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2_5.htm';
            break;
        ...
        case 'playType2812':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2_6.htm';
            break;
        ...
        case 'playType2817':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2XZXFS.htm';
            break;
        ...
        case 'playType2818':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2XZXBD.htm';
            break;
        ...
        case 'playType2819':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_2XZXBDan.htm';
            break;

        case 'playType2820':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">10</span>元。  '
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_1XDS.htm';
            break;

        case 'playType2821':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">10</span>元。;'
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_1XZH.htm';
            break;
        ...
        case 'playType2822':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/CQSSC/CQSSC_CDX.htm';
            break;
...
function SelectXing(r) {
    if (r <= 5) {
        var tempR = 5 - r;
        document.getElementById("tbMiss").value = Lottery_BuyCQSSC.BindHotAndCoolAndMiss(tempR).value;
    }
}
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_BuyCQSSC.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
