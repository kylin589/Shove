...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy3D.GetSchemeBonusScalec(currentLotteryID, GetSchemeBonusScalec_callback);

        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy3D.GetSchemeBonusScalec(" + currentLotteryID + ",GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy3D.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy3D.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetIsuseInfo_callback(response) {
    ...
    $Id("LastWinNumber").innerHTML = arrInfo[2];
    ...
    $Id("div_QH_Today").innerHTML = arrInfo[4];
...
function newBuy() {
    ...
    $Id("tagContent0").style.height="370px";
    clickPlayType('601');

    $Id("playType601").checked=true;
...
//    var v = Lottery_Buy3D.GenerateLuckLotteryNumber(lotteryID, type, name).value;
//    if (v.split("|").length < 2) {
//        alert(v);
...
//    if (document.getElementById("divYC").offsetHeight < document.getElementById("divJQ").offsetHeight + document.getElementById("divXB").offsetHeight) {

//        document.getElementById("tdNull").style.height = (document.getElementById("divJQ").offsetHeight + document.getElementById("divXB").offsetHeight - document.getElementById("divYC").offsetHeight + 10) + "px";
//    }
//}
...
//    try {
//        var LotteryNumber = Lottery_Buy3D.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
