...
function splitScheme(lotteryNumber) {
    return Lottery_BuyJX11x5.SplitScheme(lotteryNumber, document.getElementById("tbPlayTypeID").value).value;
}
...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_BuyJX11x5.GetSchemeBonusScalec(currentLotteryID, GetSchemeBonusScalec_callback);

        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_BuyJX11x5.GetSchemeBonusScalec(" + currentLotteryID + ",GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_BuyJX11x5.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_BuyJX11x5.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetIsuseInfo_callback(response) {
    ...
    lastIsuseInfo.innerHTML = lastIsuse;//上期期号
...
function ConvertDanToDT(number) {
    return Lottery_BuyJX11x5.ConvertDanToDT(number, parseInt(document.getElementById("tbPlayTypeID").value)).value;
}
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '7002':
            playTypeName = '任选二';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><i id="bPlayTypeMoney">6</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX2.htm';
            break;
        ...
        case '70022':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><i id="bPlayTypeMoney">6</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX2_DT.htm';
            break;
        ...
        case '7003':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX3.htm';
            break;
        ...
        case '70033':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">19</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX3_DT.htm';
            break;
        ...
        case '7004':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX4.htm';
            break;
        ...
        case '70044':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">78</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX4_DT.htm';
            break;
        ...
        case '7005':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX5.htm';
            break;

        case '70055':
            playTypeName = '任选五';
            document.getElementById('tbPlayTypeID').value = '7005';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><i id="bPlayTypeMoney">540</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX5_DT.htm';
            break;
        ...
        case '7006':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX6.htm';
            break;
        ...
        case '70066':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">90</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX6_DT.htm';
            break;
        ...
        case '7007':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX7.htm';
            break;
        ...
        case '70077':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><i id="spanPlayTypeMoney">26</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX7_DT.htm';
            break;
        ...
        case '7008':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX8.htm';
            break;
        ...
        case '7009':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q2Zhi.htm';
            break;
        ...
        case '7010':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q3Zhi.htm';
            break;
        ...
        case '7011':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q2Zu.htm';
            break;
        ...
        case '70111':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">65</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q2Zu_DT.htm';
            break;
        ...
        case '7012':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q3Zu.htm';
            break;
        ...
        case '70122':
            ...
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><i id="spanPlayTypeMoney">195</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q3Zu_DT.htm';
            break;
        ...
        case '7013':
            ...
            playTypeName = '前三复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">1170</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q3Fu.htm';
            break;
        ...
        case '7014':
            ...
            playTypeName = '前二复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><i id="spanPlayTypeMoney">130</i>元</font>';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_Q2Fu.htm';
            break;
        ...
        default:
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JX11X5/JX11X5_RX1.htm';
            break;
    }

    $Id('tdIntroduce').innerHTML += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><i style="color:red;cursor:pointer" id="spanExample">示例</i></strong>';

    document.getElementById("spanExample").title = Lottery_BuyJX11x5.GetExample(document.getElementById('tbPlayTypeID').value).value;//示例
