...
function GetSchemeBonusScalec(lotteryID) {

    if (!isGetSchemeBonusScalec) {
        try {

            Lottery_BuySSC.GetSchemeBonusScalec(lotteryID, GetSchemeBonusScalec_callback);
            isGetSchemeBonusScalec = true;
        }
        catch (e) {
        
            time_GetSchemeBonusScalec = setTimeout("Lottery_BuySSC.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_BuySSC.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_BuySSC.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetIsuseInfo_callback(response) {
    ...
    var QH_Today=arrInfo[2];
    var lastInseName=arrInfo[1];

    $Id("div_QH_Today").innerHTML = QH_Today;
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_BuySSC.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
currentLotteryID=lotteryID;
    if (lockInit == null) {
        ...
        init();
        GetSchemeBonusScalec(lotteryID);
        lockInit = 1;
    }
...
function newBuy() {
    ...
    $Id("Con").style.height="430px";
    SelectXing(0);
    clickPlayType("playType61001");
    $Id("playType61001").checked = true;
...
function clickPlayType(t) {
    ...
    switch (t) {
        case 'playType61001':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_5XDS.htm';
            break;
        case 'playType61002':
            playTypeName = '复选';
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_5XFS.htm';
            break;

        case 'playType61003':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">116000</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_5XZH.htm';
            break;

        case 'playType61005':
            playTypeName = '五星通选单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖<span style="color:red" id="spanPlayTypeMoney">20000</span> 元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_5XTXDS.htm';
            break;

        case 'playType61006':
            playTypeName = '五星通选复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖 <span style="color:red" id="spanPlayTypeMoney">20000</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_5XTXFS.htm';
            break;
        ...
        case 'playType61101':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_4XDS.htm';
            break;
        ...
        case 'playType61102':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_4XFS.htm';
            break;

        case 'playType61103':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码千、百、十、个位与开奖号码全部相同且顺序一致，奖金 <span style="color:red" id="spanPlayTypeMoney">10000</span> 元。 ';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_4XZH.htm';
            break;
        ...
        case 'playType61201':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_3XDS.htm';
            break;
        ...
        case 'playType61202':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_3XFS.htm';
            break;

        case 'playType61203':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">1160</span>元。';
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_3XZH.htm';
            break;
        ...
        case 'playType61306':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2XZXFS.htm';
            break;
        ...
        case 'playType61307':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2XZXBD.htm';
            break;
        ...
        case 'playType61308':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2XZXBDan.htm';
            break;

        case 'playType61401':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">11</span>元。  '
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_1XDS.htm';
            break;

        case 'playType61402':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">11</span>元。;'
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_1XZH.htm';
            break;
        ...
        case 'playType61501':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_CDX.htm';
            break;
        ...
        case 'playType61204':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2_3.htm';
            break;
        ...
        case 'playType61205':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2_4.htm';
            break;
        ...
        case 'playType61206':
            ...
            iframe_playtypes.location.href = '../Home/Room/playtypes/JXSSC/JXSSC_2_5.htm';
            break;
...
function clickPlayClass(i, obj) {
    ...
    var pts="playType61"+String(i)+"01";
    $Id("playType61" + String(i) + "01").checked = true;
...
function SelectXing(r) {
    if (r <= 5) {
        var tempR = 5 - r;
        document.getElementById("tbMiss").value = Lottery_BuySSC.BindHotAndCoolAndMiss(tempR).value;
...
function Loads()
{
    document.getElementById("playType61001").checked=true;
    //SelectXing(0);
