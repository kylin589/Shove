...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
           ...
           Lottery_BuyCJDLT.GetSchemeBonusScalec(currentLotteryID, GetSchemeBonusScalec_callback);

        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_BuyCJDLT.GetSchemeBonusScalec(" + currentLotteryID + ",GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
       ...
       Lottery_BuyCJDLT.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
       ...
       Lottery_BuyCJDLT.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function newBuy() {
    ...
    $Id("tagContent0").style.height="330px";
    
    clickPlayType('3901');

    $Id("playType3901").checked=true;
 ...
 function clickPlayType(t) {
   document.getElementById('tbPlayTypeID').value = t;
        ...
        case '3902':
            ...
            $Id('HidPrice').value = '2';
            document.getElementById("Money").innerText ="2";
            break;
        ...
        case '3903':
            ...
            $Id('HidPrice').value = '3';
            $Id('Money').value = '3';
            document.getElementById("Money").innerText ="3";
            break;
