...
public partial class Home_Room_Message : SitePageBase
{
    ...
    private void BindDataForSystemMessage()
    {
        ...
        if (dt == null)
        {
            ...
            string sql = "select '系统消息' as SourceUserName,ID,DateTime,Content,isRead from T_StationSMS where isShow = 1 and Type = 2 and AimID = " + _User.ID.ToString() + " order by isRead asc";
