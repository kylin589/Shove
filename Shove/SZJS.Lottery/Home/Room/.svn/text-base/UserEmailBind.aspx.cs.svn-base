...
public partial class Home_Room_UserEmailBind : SitePageBase
{
    ...
    private void BindData()
    {
        ...
        btnBind.Enabled = !_User.isEmailValided;
        btnReBind.Enabled = _User.isEmailValided;
    }
    ...
    protected void btnBind_Click(object sender, EventArgs e)
    {
        ...
        sb.Append("<div style='font-weight:bold;'>尊敬的" + _Site.Name + "客户(").Append(_User.Name).Append("):</div>")
            ...
            .Append("<div>").Append(Shove._Web.Utility.GetUrlWithoutHttp()).Append(" 版权所有(C) 深圳市久盛网络技术有限公司</div>");
