...
public partial class Home_Room_ScoringDetail : SitePageBase
{
    ...
    {
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable(Shove._Web.WebConfig.GetAppSettingsString("SystemPreFix") + _Site.ID.ToString() + "ScoringDetail_" + _User.ID.ToString());
        ...
        if (dt == null)
        {
            ...
            Shove._Web.Cache.SetCache(Shove._Web.WebConfig.GetAppSettingsString("SystemPreFix") + _Site.ID.ToString() + "ScoringDetail_" + _User.ID.ToString(), dt);
        }
