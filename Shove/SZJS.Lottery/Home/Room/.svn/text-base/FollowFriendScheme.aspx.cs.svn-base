...
public partial class Home_Room_FollowFriendScheme : SitePageBase
{
    ...
    protected void g_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.EditItem)
        {
            ...
            if (FollowStatus == 1)
            {
                lbEdit.Text = "<script>var e_script_" + dr["ID"].ToString() + "=\"parent.iframeFollowScheme.showDialog('FollowFriendSchemeEdit.aspx?FollowUserID=" + dr["ID"].ToString() + "&FollowUserName=" + System.Web.HttpUtility.UrlEncode(dr["Name"].ToString()) + "&&UserID=" + _User.ID.ToString() + "&Number=" + HidNumber.Value + "')\";</script><a href='javascript:;' onclick=\"if(parent.CreateLogin(e_script_" + dr["ID"].ToString() + ")){showDialog('FollowFriendSchemeEdit.aspx?FollowUserID=" + dr["ID"].ToString() + "&FollowUserName=" + System.Web.HttpUtility.UrlEncode(dr["Name"].ToString()) + "&UserID=" + _User.ID.ToString() + "&Number=" + HidNumber.Value + "');}\">修改</a>";
                Cancel.Visible = true;
