...
public partial class Home_Room_EmailReg : SitePageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (email != user.Email)
                {
                    labValided.Text = "您的邮箱地址不符，请到大厅，我的资料中重新发起激活。<br/><div style='color:black'>前往 <a href=\"../../Index.aspx\">购买彩票</a>&nbsp;&nbsp; <a href=\"AccountDetail.aspx\">用户中心</a></div>";
                    tbOk.Visible = false;
                    tbFailure.Visible = true;
                ...
                {
                    labValided.Text = "您的邮箱已激活，不需要再次激活。<br/><div style='color:black'>前往 <a href=\"../../Index.aspx\">购买彩票</a>&nbsp;&nbsp; <a href=\"AccountDetail.aspx\">我的账户</a></div>";
                    tbOk.Visible = false;
                    tbFailure.Visible = true;
                ...
                labValided.Text = "邮箱激活成功。<br/><div color:black'>前往 <a href=\"../../Index.aspx\">购买彩票</a> &nbsp; &nbsp; <a href=\"AccountDetail.aspx\">我的账户</a></div>";
            }
            catch
            {
